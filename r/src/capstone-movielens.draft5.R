...
# umgy_effect_best_lambda <- train_UMGY_effect._effect.cv(best_umgy_effect_lambda)
...
umgy_effect_best_lambda_RMSE <- calc_UMGY_effect._effect_RMSE.cv(umgy_effect_best_lambda)
