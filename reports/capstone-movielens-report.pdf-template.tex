...
\hypersetup{backref, pdfpagemode=FullScreen, colorlinks=true, implicit=false}
\ifLuaTeX
...
MovieLens dataset}. Following the \emph{Netflix Grand Prize
Contest}\autocite{NYT1MNP} requirements, we will evaluate the RMSE score
defined as:
