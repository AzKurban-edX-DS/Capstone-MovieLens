...
Below, we provide the most important code of the training our model
using the \texttt{5-Fold\ Cross\ Validation} method:
...
\begin{noteblock}
The functions described below are defined in the \href{}{Model Tuning}
section of the \href{}{common-helper.functions.R} script.

\end{noteblock}

\subparagraph{\texorpdfstring{\texttt{tune.model\_param}
Function}{tune.model\_param Function}}\label{tune.model_param-function}
...
\NormalTok{  prm\_val.best }\OtherTok{\textless{}{-}} \ConstantTok{NA}
  ...
  \FunctionTok{put\_log}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{param\_values:"}\NormalTok{)}
  \FunctionTok{put}\NormalTok{(param\_values)}
...
\NormalTok{    prm\_val }\OtherTok{\textless{}{-}}\NormalTok{ param\_values[i]}
    \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{prm\_val: \%1"}\NormalTok{, prm\_val)}
...
\StringTok{param\_vals\_tmp[\%1]: \%2"}\NormalTok{, i, param\_vals\_tmp[i])}
    \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{param\_vals\_tmp length: \%1"}\NormalTok{, }\FunctionTok{length}\NormalTok{(param\_vals\_tmp))}
    \FunctionTok{put}\NormalTok{(param\_vals\_tmp)}

\NormalTok{    RMSE\_tmp }\OtherTok{\textless{}{-}} \FunctionTok{fn\_tune.test.param\_value}\NormalTok{(prm\_val)}

    \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{RMSE\_tmp: \%1"}\NormalTok{, RMSE\_tmp)}
\NormalTok{    RMSEs\_tmp[i] }\OtherTok{\textless{}{-}}\NormalTok{ RMSE\_tmp}
    
    \FunctionTok{put\_log2}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{RMSEs\_tmp[\%1]: \%2"}\NormalTok{, i, RMSEs\_tmp[i])}
    \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{RMSEs\_tmp length: \%1"}\NormalTok{, }\FunctionTok{length}\NormalTok{(RMSEs\_tmp))}
    \FunctionTok{put}\NormalTok{(RMSEs\_tmp)}
    
    \FunctionTok{plot}\NormalTok{(param\_vals\_tmp[RMSEs\_tmp }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{], RMSEs\_tmp[RMSEs\_tmp }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{])}
    \CommentTok{\# browser()}
...
\NormalTok{  param\_values.best\_result }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\AttributeTok{param.best\_value =}\NormalTok{ prm\_val.best, }
  ...
  \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: \textasciigrave{}tune.model\_param\textasciigrave{}:}
\StringTok{Completed with RMSEs\_tmp length: \%1"}\NormalTok{, }\FunctionTok{length}\NormalTok{(RMSEs\_tmp))}
...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-84-1.pdf}
