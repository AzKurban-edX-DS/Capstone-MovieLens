...
\begin{noteblock}
This code snippet is a part of the \texttt{make\_source\_datasets}
...
\begin{noteblock}
The \texttt{sample\_train\_validation\_sets} function is defined in the
same script as the \texttt{make\_source\_datasets} one, from where it is
called.
...
\subparagraph{Functions to calculate \_(Root) Mean Squared
Error}\label{functions-to-calculate-_root-mean-squared-error}
