...
\begin{noteblock}
Note that the function assumes that the dependence of the \texttt{RMSE}
...
is assumed to have a single minimum in the domain of definition.
...
\NormalTok{    file\_name\_tmp }\OtherTok{\textless{}{-}}\NormalTok{ cache\_file\_base\_name }\SpecialCharTok{|\textgreater{}}
      ...
      \FunctionTok{str\_c}\NormalTok{(}\StringTok{"\_"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{str\_c}\NormalTok{(}\FunctionTok{as.character}\NormalTok{(range\_divider)) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{      tuned.result }\OtherTok{\textless{}{-}}\NormalTok{ tuned\_result}\SpecialCharTok{$}\NormalTok{tuned.result}
      ...
      \ControlFlowTok{if}\NormalTok{(}\FunctionTok{length}\NormalTok{(file\_path\_tmp) }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{) \{}
\NormalTok{      \}}
...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-95-1.pdf}
