...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-52-1.pdf}
...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-65-1.pdf}
...
\item
  ...
  range of \texttt{lambda} values for the
  \texttt{5-Fold\ Cross\ Validation} samples;
\item
  \textbf{Fine-tuning:} figuring out the value of \texttt{lambda} that
...
This function calculates the \emph{RMSE} for the given \(\lambda\)
parameter value:
...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-85-1.pdf}
