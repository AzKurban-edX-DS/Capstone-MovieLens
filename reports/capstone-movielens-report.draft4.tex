...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-40-1.pdf}
...
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/914dd47023dc21b6b06a0ca412b7f7281602275a/r/src/support-functions/common-helper.functions.R\#L630}{\texttt{data.plot}
function} defined in
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/914dd47023dc21b6b06a0ca412b7f7281602275a/r/src/support-functions/common-helper.functions.R\#L484}{\emph{Model
Data Visualization} section} of the
...
Here we also used
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/914dd47023dc21b6b06a0ca412b7f7281602275a/r/src/support-functions/common-helper.functions.R\#L54}{\texttt{naive\_model\_MSEs}
...
script} to compute \emph{Mean Squared Errors} using \emph{5-Fold Cross
Validation} method:
...
One more function we will need for further analysis of the current model
is the
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/914dd47023dc21b6b06a0ca412b7f7281602275a/r/src/support-functions/common-helper.functions.R\#L59}{\texttt{naive\_model\_RMSE}
one} defined in the
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R}{common-helper.functions.R}
script already mentioned above:
...
\NormalTok{  \})}
  \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"RMSE values have been computed for \%1 deviations from the Overall Mean Rating."}\NormalTok{,}
           \FunctionTok{length}\NormalTok{(deviation))}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Warning in is.na(xlabel): is.na() applied to non-(list or vector) of type 'expression'
\end{verbatim}

\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-44-1.pdf}
...
\begin{verbatim}
## Is the previously computed RMSE the best for the current model: FALSE
\end{verbatim}
...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-57-1.pdf}
