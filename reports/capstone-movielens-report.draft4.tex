...
parameter of the {[}tune.model\_param{]} function that is called
internally during the execution (see the
\hyperref[func.tune.model_param]{description of the
\texttt{tune.model\_param} function} above).
