...
to aggregate the ``cross-validation'' results.
...
defined in the
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R}
script to calculate the \texttt{MSE} of the \texttt{UME\ Model} for the
given \texttt{Test\ Set} is provided below:
...
defined in the
\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R}
script to calculate the \texttt{RMSE} of the \texttt{UME\ Model} for the
given \texttt{Test\ Set} is provided below:
...
\includegraphics{capstone-movielens-report.draft4_files/figure-latex/unnamed-chunk-83-1.pdf}
