...
::: {.noteblock data-latex=""}
In the code snippet above we use the [train_UMGY_effect.cv](#func.train_UMGY_effect.cv) user-defined function described in the [Models Training: Support Functions]/[UMGE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippets above, we use the [calc_UMGY_effect_RMSE.cv](#func.calc_UMGY_effect_RMSE.cv) user-defined function described in the [Models Training: Support Functions]/[UMGYE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippet above, we use the [calc_UMGY_effect_RMSE.cv](#func.calc_UMGY_effect_RMSE.cv) function described in the [Models Training: Support Functions]/[UMGYE Model: Utility Functions] section of [Appendix A](#appndx_a). 
:::
