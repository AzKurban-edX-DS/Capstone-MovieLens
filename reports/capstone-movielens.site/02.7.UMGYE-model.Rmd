...
::: {.noteblock data-latex=""}
In the code snippet above we use the [train_UMGY_effect.cv](#func.train_UMGY_effect.cv) user-defined function described in the [UMGE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippets above, we use the [calc_UMGY_effect_RMSE.cv](#func.calc_UMGY_effect_RMSE.cv) user-defined function described in the [UMGYE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
Next, we will implement the *UMGYE Model Regularization* in the following three steps:
  ...
  3. **Retraining:** (Described in subsection [UMGYE Model Regularization: *Retraining the Model with the best* $\lambda$]) Retraining the model with the best value of $\lambda$ determined in the previous step.
...
::: {.noteblock data-latex=""}
In the code snippet above we use the [train_UMGY_effect](#func.train_UMGY_effect) function described in the [UMGYE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippet above, we use the [calc_UMGY_effect_RMSE.cv](#func.calc_UMGY_effect_RMSE.cv) function described in the [UMGYE Model: Utility Functions] section of [Appendix A](#appndx_a). 
:::
