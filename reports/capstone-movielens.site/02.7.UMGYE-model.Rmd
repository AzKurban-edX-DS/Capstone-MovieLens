...
We can now validate the current model by computing the *RMSE* for the *UMGY* Effect using the following [line of code](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L): 
```{r, eval=FALSE}
