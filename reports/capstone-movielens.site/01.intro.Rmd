...
We install the development version of this package from the _GitHub repository_ and attach the correspondent library to the global environment using the following [code snippet](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/_startup/1.init.R#L16):
...
In the code snippet above, we use the user-defined helper function [put_log](#func.put_log) described above in the [Logging Functions] section of *this Appendix*.
:::  
...
::: {.noteblock data-latex=""}
The line of code above is used in the [make_source_datasets](#func.make_source_datasets) user-defined helper function described in detail in section [Initializing Input Datasets] of [Appendix A](#appndx_a).
:::
