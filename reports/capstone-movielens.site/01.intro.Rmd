...
To start with we have to generate two datasets derived from the _MovieLens_ dataset mentioned [above](#intro):
...
Now, note the expressions below which confirm the fact explained in [Section _23.1.1 Movielens data_](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/regularization.html#movielens-data) of the _Course Textbook_[@IDS2_23-1-1] that not every user rated every movie:
```{r}
