...
::: {.noteblock data-latex=""}
The line of code above is used in the [init_source_datasets](#func.init_source_datasets) user-defined helper function described in detail in section [Initializing Input Datasets] of [Appendix A](#appndx_a).
:::
