...
::: { #func.union_cv_results.params.data_list .sidebar }
...
Plots a graph based on the dataset passed in the [data](#func.data.plot.params.data) parameter, using both points and a line.
...
Plots a graph based on the first $n$ rows (the $n$ is specified by the [left.n](#func.data.plot.left.n.params.left.n) parameter) of the dataset passed in the [data](#func.data.plot.left.n.params.data) parameter, using both points and a line.

::: {.noteblock data-latex=""}
The dataset passed in the [data](#func.data.plot.left.n.params.data) parameter is assumed to be sorted by the column used for the $x$ axis (specified by the column name passed in the [xname](#func.data.plot.left.n.params.xname) parameter).
:::
...
::: { #func.data.plot.left.n.params .sidebar }
#### Parameters
\

::: { #func.data.plot.left.n.params.data .sidebar }
  - **data:** Dataset to use for the plot. 

:::
::: { #func.data.plot.left.n.params.left.n .sidebar }
...
:::
::: { #func.data.plot.left.n.params.title .sidebar }
  - **title:** Title of the plot. 

:::
::: { #func.data.plot.left.n.params.xname .sidebar }
  - **xname:** The name of the dataset column used as the source of the $x$ variable for the plot. 

:::
::: { #func.data.plot.left.n.params.yname .sidebar }
  - **yname:** The name of the dataset column used as the source of the $y$ variable for the plot. 

:::
::: { #func.data.plot.left.n.params.xlabel .sidebar }
  - *xlabel = NULL*:** The $x$ axis label. If `NULL`, the value of the `xname` parameter is used for the label. 

:::
::: { #func.data.plot.left.n.params.ylabel .sidebar }
  - **ylabel = NULL:** The $y$ axis label. If `NULL`, the value of the `yname` parameter is used for the label. 

:::
::: { #func.data.plot.left.n.params.line_col .sidebar }
  - **line_col = blue:** The line color. 

:::
::: { #func.data.plot.left.n.params.normalize .sidebar }
  - **normalize = FALSE:** If `TRUE`, the deviation of $y$ from its mean is used to plot, rather than $y$ values. Otherwise, the value of $y$ is used.
...
The function is a wrapper for the [data.plot](#func.data.plot) function described above and is a simple and convenient tool for more detailed visualization of the left part of the graph, initially built based on the entire data set passed in the [data](#func.data.plot.left.n.params.data) parameter.
:::
...
::: {.noteblock data-latex=""}
The source code of the [data.plot.left.n](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L493) is also available in the [Data Visualization](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L447) section of the [data.helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L493) script.
:::
:::
...
::: { #func.data.plot.left_detailed.params .sidebar }
#### Parameters
\

::: { #func.data.plot.left_detailed.params.data .sidebar }
  - **data:** Dataset to use for the plot. 
...
:::
::: { #func.data.plot.left_detailed.params.title .sidebar }
  - **title:** Title of the plot. 

:::
::: { #func.data.plot.left_detailed.params.xname .sidebar }
  - **xname:** The name of the dataset column used as the source of the $x$ variable for the plot. 

:::
::: { #func.data.plot.left_detailed.params.yname .sidebar }
  - **yname:** The name of the dataset column used as the source of the $y$ variable for the plot. 

:::
::: { #func.data.plot.left_detailed.params.xlabel1 .sidebar }
  - *xlabel1 = NULL*:** The $x$ axis label for the first plot. If `NULL`, the value of the `xname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.params.xlabel2 .sidebar }
  - *xlabel2 = NULL*:** The $x$ axis label for the second plot. If `NULL`, the value of the `xname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.params.ylabel1 .sidebar }
  - **ylabel1 = NULL:** The $y$ axis label for the first plot. If `NULL`, the value of the `yname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.params.ylabel2 .sidebar }
  - **ylabel2 = NULL:** The $y$ axis label for the second plot. If `NULL`, the value of the `yname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.params.line_col .sidebar }
  - **line_col = blue:** The line color. 

:::
::: { #func.data.plot.left_detailed.params.normalize .sidebar }
  - **normalize = FALSE:** If `TRUE`, the deviation of $y$ from its mean is used to plot, rather than $y$ values. Otherwise, the value of $y$ is used.
...
::: {.noteblock data-latex=""}
The source code of the [data.plot.left_detailed](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L448) is also available in the [Data Visualization](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L447) section of the [data.helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L448) script.
:::
:::



### [data.helper.func0]() Function {#func.data.helper.func0}
\

::: { #func.data.helper.func0.Usage .sidebar }
#### Usage
\
...
::: { #func.data.helper.func0.params .sidebar }
#### Parameters
\

::: { #func.data.helper.func0.params.p1 .sidebar }
  - **p1:** description; 

:::
::: { #func.data.helper.func0.params.2 .sidebar }
  - **p2:** description. 

:::
:::

::: { #func.data.helper.func0.details .sidebar }
#### Details
\
...
::: { #func.data.helper.func0.value .sidebar }
#### Value
\

:::

::: { #func.data.helper.func0.code .sidebar }
#### Source Code
\

The soure code of the [data.helper.func0]() function is shown below:
```{r eval=FALSE}
...
## Regularization: Common Helper Functions {#appndx_a.rglr.common_helper.functions}
\
...
::: {.noteblock data-latex=""}
The complete version of the source code of the [model.tune.param_range](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L198) is available in the [Model Tuning](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L74) section of the [common-helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L198) script.
:::
:::
...
::: {#func.get_fine_tune.param.endpoints.params.preset.result .sidebar }
##### ***preset.result***
\
...
::: { #func.fname00.params.p1 .sidebar }
  - **p1:** description; 

:::
::: { #func.fname00.params.2 .sidebar }
  - **p2:** description. 
