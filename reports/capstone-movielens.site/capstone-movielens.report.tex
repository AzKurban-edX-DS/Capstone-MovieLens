...
\begin{noteblock}
We use the custom data visualization function \hyperref[func.data.plot]{data.plot} described in the \hyperref[appndx_a.data_helper.functions]{Appendix} of this report, which is defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L447}{Data Visualization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L592}{data.helper.functions.R} script.
...
\hfill\break
::: \{ \#func.mean\_reg.params.param1 .sidebar \}
...
\phantomsection\label{func.data.plot.value}
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-4}
...
\phantomsection\label{func.fname00.params.param2}
\begin{itemize}
\tightlist
\item
  \textbf{param2:} description.
