...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-278-1.pdf}}
...
\begin{noteblock}
The complete source code of building and training the current model is available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1823}{UMGYDE Model Tuning: Step 1 (\texttt{degree\ =})} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1823}{capstone-movielens.main.R} script on \emph{GitHub}.
