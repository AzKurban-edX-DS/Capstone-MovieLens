...
\paragraph{User+Movie Effect Model Tuning: Pre-configuratioin}\label{usermovie-effect-model-tuning-pre-configuratioin}
...
\paragraph{\texorpdfstring{Retraining User+Movie Effect Model with the best \(\lambda\)}{Retraining User+Movie Effect Model with the best \textbackslash lambda}}\label{retraining-usermovie-effect-model-with-the-best-lambda}
...
\subsubsection{UME Model: Support Functions}\label{ume-model-support-functions-1}
...
\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L2}{train\_user\_movie\_genre\_effect} Function}{train\_user\_movie\_genre\_effect Function}}\label{func.train_user_movie_genre_effect}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train\_user\_movie\_genre\_effect }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(train\_set, }\AttributeTok{lambda =} \DecValTok{0}\NormalTok{)\{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{is.na}\NormalTok{(lambda)) \{}
...
We use the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L17}{train\_user\_movie\_genre\_effect.cv} function to build and train our model using the \texttt{5-Fold\ Cross\ Validation} method. Below, we provide the most important part of the code of that function:
...
\CommentTok{\# ...}
\NormalTok{  start }\OtherTok{\textless{}{-}} \FunctionTok{put\_start\_date}\NormalTok{()}
\NormalTok{  user\_movie\_genre\_effects\_ls }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(edx\_CV, }\ControlFlowTok{function}\NormalTok{(cv\_fold\_dat)\{}
\NormalTok{    cv\_fold\_dat}\SpecialCharTok{$}\NormalTok{train\_set }\SpecialCharTok{|\textgreater{}} \FunctionTok{train\_user\_movie\_genre\_effect}\NormalTok{(lambda)}
\NormalTok{  \})}
  \FunctionTok{put\_end\_date}\NormalTok{(start)}
  \FunctionTok{put\_log}\NormalTok{(}\StringTok{"Function: train\_user\_movie\_genre\_effect.cv:}
\StringTok{User+Movie Effect list have been computed"}\NormalTok{)}
...
The code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L55}{calc\_user\_movie\_genre\_effect\_MSE} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R} script to calculate the \texttt{Mean\ Squared\ Error\ (MSE)} of the \texttt{UME\ Model} for the given \texttt{Test\ Set} is provided below:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_user\_movie\_genre\_effect\_MSE }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(test\_set, um\_effect)\{}
\NormalTok{  mse.result }\OtherTok{\textless{}{-}}\NormalTok{ test\_set }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(edx.user\_effect, }\AttributeTok{by =} \StringTok{"userId"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(um\_effect, }\AttributeTok{by =} \StringTok{"movieId"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{resid =}\NormalTok{ rating }\SpecialCharTok{{-}} \FunctionTok{clamp}\NormalTok{(mu }\SpecialCharTok{+}\NormalTok{ a }\SpecialCharTok{+}\NormalTok{ b)) }\SpecialCharTok{|\textgreater{}} 
...
The code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L72}{calc\_user\_movie\_genre\_effect\_MSE.cv} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R} script to calculate the \texttt{5-Fold\ Cross\ Validation} MSE result of the \texttt{UME\ Model} is provided below:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_user\_movie\_genre\_effect\_MSE.cv }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(um\_effect)\{}
  \FunctionTok{put\_log}\NormalTok{(}\StringTok{"Function: user\_movie\_genre\_effects\_MSE.cv:}
\StringTok{Computing the RMSE taking into account User+Movie Effects..."}\NormalTok{)}
\NormalTok{  start }\OtherTok{\textless{}{-}} \FunctionTok{put\_start\_date}\NormalTok{()}
\NormalTok{  user\_movie\_genre\_effects\_MSEs }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(edx\_CV, }\ControlFlowTok{function}\NormalTok{(cv\_fold\_dat)\{}
\NormalTok{    cv\_fold\_dat}\SpecialCharTok{$}\NormalTok{validation\_set }\SpecialCharTok{|\textgreater{}} \FunctionTok{calc\_user\_movie\_genre\_effect\_MSE}\NormalTok{(um\_effect)}
\NormalTok{  \})}
  \FunctionTok{put\_end\_date}\NormalTok{(start)}
  
  \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: user\_movie\_genre\_effects\_MSE.cv:}
\StringTok{MSE values have been plotted for the \%1{-}Fold Cross Validation samples."}\NormalTok{, }
\NormalTok{           CVFolds\_N)}
...
The code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L51}{calc\_user\_movie\_genre\_effect\_RMSE} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R} script to calculate the \texttt{Root\ Mean\ Squared\ Error\ (RMSE)} of the \texttt{UME\ Model} for the given \texttt{Test\ Set} is provided below:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_user\_movie\_genre\_effect\_RMSE }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(test\_set, um\_effect)\{}
\NormalTok{  mse }\OtherTok{\textless{}{-}}\NormalTok{ test\_set }\SpecialCharTok{|\textgreater{}} \FunctionTok{calc\_user\_movie\_genre\_effect\_MSE}\NormalTok{(um\_effect)}
  \FunctionTok{sqrt}\NormalTok{(mse)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
The code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L65}{calc\_user\_movie\_genre\_effect\_RMSE.cv} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R} script to calculate the \texttt{5-Fold\ Cross\ Validation} RMSE result of the \texttt{UME\ Model} is provided below:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_user\_movie\_genre\_effect\_RMSE.cv }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(um\_effect)\{}
\NormalTok{  user\_movie\_genre\_effects\_MSE }\OtherTok{\textless{}{-}} \FunctionTok{calc\_user\_movie\_genre\_effect\_MSE.cv}\NormalTok{(um\_effect)}
\NormalTok{  um\_effect\_RMSE }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(user\_movie\_genre\_effects\_MSE)}
  \FunctionTok{put\_log2}\NormalTok{(}\StringTok{"Function: user\_movie\_genre\_effects\_RMSE.cv:}
\StringTok{\%1{-}Fold Cross Validation ultimate RMSE: \%2"}\NormalTok{, CVFolds\_N, um\_effect\_RMSE)}
\NormalTok{  um\_effect\_RMSE}
\NormalTok{\}}
\end{Highlighting}
