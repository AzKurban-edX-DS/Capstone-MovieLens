...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-79-1.pdf}}
...
\begin{tabular}{>{\raggedright\arraybackslash}p{15em}>{\centering\arraybackslash}p{5em}>{\raggedright\arraybackslash}p{32em}}
\toprule
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-94-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-99-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-101-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-124-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-133-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-139-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-142-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-189-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-192-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-221-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-238-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-241-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-291-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-294-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-299-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-302-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-307-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-310-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-315-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-324-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-327-1.pdf}}
...
\begin{noteblock}
Now, we have a better result than one for the previous model, but still insufficient to meet the Project Objective.
...
Plots a graph based on the dataset passed in the \hyperref[func.data.plot.left.n.params.data]{data} parameter, using both points and a line.
...
The function is a wrapper for the \hyperref[func.data.plot]{data.plot} function described above and is a simple and convenient tool for more detailed visualizing the left part of the graph.
...
The soure code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L493}{data.plot.left.n} function is shown below:
...
\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L493}{data.plot.left.n} is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L447}{Data Visualization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L493}{data.helper.functions.R} script.
...
Plots a graph based on the dataset passed in the \hyperref[func.data.plot.left_detailed.params.data]{data} parameter, using both points and a line.
...
\phantomsection\label{func.data.plot.left_detailed.params.xlabel}
\begin{itemize}
\tightlist
\item
  \emph{xlabel = NULL}:** The \(x\) axis label. If \texttt{NULL}, the value of the \texttt{xname} parameter is used for the label;
...
\phantomsection\label{func.data.plot.left_detailed.params.ylabel}
\begin{itemize}
\tightlist
\item
  \textbf{ylabel = NULL:} The \(y\) axis label. If \texttt{NULL}, the value of the \texttt{yname} parameter is used for the label.;
...
The function is a wrapper for the \hyperref[func.data.plot.left.n]{data.plot.left.n} function described above and is a simple and convenient tool for more detailed visualizing the left part of the graph.
...
\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L448}{data.plot.left\_detailed} is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L447}{Data Visualization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L448}{data.helper.functions.R} script.
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-29}
...
\paragraph{\texorpdfstring{\textbf{Details}}{Details}}\label{details-16}
...
\paragraph{Source Code}\label{source-code-43}
...
\paragraph{Parameters}\label{parameters-44}
...
\paragraph{Source Code}\label{source-code-44}
...
\paragraph{Parameters}\label{parameters-45}
...
\paragraph{Details}\label{details-32}
...
\paragraph{Source Code}\label{source-code-45}
