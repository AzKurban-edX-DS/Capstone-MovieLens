...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-180-1.pdf}}
...
Therefore, the values of \(g_{i,j}\) that minimize this equation are:
\[
\hat{g}_{i,j}(\lambda) = \frac{1}{\lambda + n_{i,j}} \sum_{i=1}^{n_{g}} \left(Y_{i,j} - \mu - \alpha_i - \beta_j\right)
\]
where \(n_{g}\) is the number of ratings made per each genre.
...
\begin{noteblock}
The \href{}{regularize.test\_lambda.UMG\_effect.cv} function described below are defined in the \href{}{Regularization} section of the \href{}{UM-effect.functions.R} script.

\end{noteblock}

\subparagraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L96}{regularize.test\_lambda.UMG\_effect.cv} Function}{regularize.test\_lambda.UMG\_effect.cv Function}}\label{func.regularize.test_lambda.UMG_effect.cv}
...
\begin{noteblock}
Note that we reuse the function \hyperref[func.train_UMG_effect.cv]{train\_UMG\_effect.cv} calling it from the \hyperref[func.regularize.test_lambda.UMG_effect.cv]{regularize.test\_lambda.UMG\_effect.cv}, but now with the \(\lambda\) parameter different from the default (`lambda = 0') value.

\end{noteblock}

\newpage

\paragraph{UMGE Model Regularization: Pre-configuratioin}\label{umge-model-regularization-pre-configuratioin}
...
\begin{noteblock}
The complete version of the source code provided in this section can be found in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L814}{Preliminary setting-up of lambda range for UMG Effect regularization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R}{capstone-movielens.main.R} script.
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-219-1.pdf}}
