...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{writeLines}\NormalTok{(}\StringTok{"*** Fine{-}tuning results object data structure ***"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{writeLines}\NormalTok{(}\StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{writeLines}\NormalTok{(}\StringTok{"*** Fine{-}tuning: best results ***"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{writeLines}\NormalTok{(}\StringTok{"*** Fine{-}tuning: best parameter value ***"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## *** Fine-tuning: best parameter value ***
\end{verbatim}
...
Finally, we retrain our model with the best \(\lambda\) parameter value we have just figured out:
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{writeLines}\NormalTok{(}\StringTok{"*** The Best Fine{-}tuning Results ***"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
  \FunctionTok{print\_log1}\NormalTok{(}\StringTok{"Re{-}training Regularized User+Movie Effect Model for the best \textasciigrave{}lambda\textasciigrave{}: \%1..."}\NormalTok{,}
\NormalTok{           UME.rglr.best\_lambda)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Re-training Regularized User+Movie Effect Model for the best `lambda`: 0.38745002746582...
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{writeLines}\NormalTok{(}\StringTok{"*** Regularized User+Movie Effect Structure ***"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Finally, after \emph{Regularization}, we obtained the following result:
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print\_log1}\NormalTok{(}\StringTok{"Regularized User+Movie Effect Model has been re{-}trained for the best \textasciigrave{}lambda\textasciigrave{}: \%1."}\NormalTok{,}
\NormalTok{         UME.rglr.best\_lambda)}
\end{Highlighting}
\end{Shaded}
