...
\subsubsection{UMGYDE Model Tuning}\label{umgyde-model-tuning}
...
\subparagraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L97}{regularize.train\_UMGYD\_effect} Function}{regularize.train\_UMGYD\_effect Function}}\label{func.regularize.train_UMGYD_effect}

\hfill\break

This is a helper function that calculates the \emph{Smoothed Day Effect} of the user ratings and is intended to be used in other functions and scripts (such as \hyperref[func.regularize.train_UMGYD_effect]{regularize.train\_UMGYD\_effect}) described below.

Parameters

\hfill\break

\phantomsection\label{func..params.}
\begin{itemize}
\tightlist
\item
  \textbf{\emph{train\_set:}}
...
\item
  \textbf{\emph{lambda:}}
  As explained \hyperref[sec.umgydem.support_functions.note.lambda]{above} in the {[}{]} section, this is the \(\lambda\) coefficient of the penalty of the \emph{Regularization} method.
\end{itemize}
...
\hfill\break
Under the hood, the function internally calls the
...
\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L97}{regularize.train\_UMGYD\_effect} function is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L1}{UMGYDE Model Support Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L97}{UMGYD-effect.functions.R} script on \emph{GitHub}.
...
\subparagraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L190}{regularize.train\_UMGYD\_effect.cv} Function}{regularize.train\_UMGYD\_effect.cv Function}}\label{func.regularize.train_UMGYD_effect.cv}
...
\hfill\break
Under the hood, the function internally calls the \hyperref[func.train_UMGY_SmoothedDay_effect.RMSE.cv]{train\_UMGY\_SmoothedDay\_effect.RMSE.cv} described above with the fixed \hyperref[func.train_UMGY_SmoothedDay_effect.RMSE.cv.params.degree]{degree} parameter value of 0 and the \hyperref[func.train_UMGY_SmoothedDay_effect.RMSE.cv.params.span]{span} parameter value taken from the \hyperref[func.regularize.train_UMGYD_effect.cv.params.span]{parameter of the same name} of this function to compute the \texttt{RMSE} of the model to be tuned.
...
\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L190}{regularize.train\_UMGYD\_effect.cv} function is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L170}{Tuning \texttt{loess} Parameters} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L190}{UMGYD-effect.functions.R} script on \emph{GitHub}.
...
\hfill\break
\emph{Root Mean Square Error (RMSE)} of the \emph{UMGYD} model trained using the \href{https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/loess}{stats::loess} function called with the given \hyperref[func.regularize.train_UMGYD_effect.cv.params.span]{span} parameter and the \texttt{degree} parameter value equal to 0.
...
\begin{noteblock}
The \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L240}{regularize.test\_lambda.UMGYD\_effect.cv} function are defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L222}{Regularization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L240}{UM-effect.functions.R} script on \_GitHub.
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-289-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-292-1.pdf}}
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-27}
...
\paragraph{\texorpdfstring{\textbf{Details}}{Details}}\label{details-15}
...
\paragraph{Parameters}\label{parameters-33}
...
\paragraph{Parameters}\label{parameters-34}
...
\paragraph{Source Code}\label{source-code-33}
...
\paragraph{Parameters}\label{parameters-35}
...
\paragraph{Details}\label{details-23}
...
\paragraph{Source Code}\label{source-code-34}
...
\paragraph{Parameters}\label{parameters-36}
...
\paragraph{Details}\label{details-24}
...
\paragraph{Source Code}\label{source-code-35}
...
\paragraph{Parameters}\label{parameters-37}
...
\paragraph{Details}\label{details-25}
...
\paragraph{Source Code}\label{source-code-36}
...
\paragraph{Parameters}\label{parameters-38}
...
\paragraph{Details}\label{details-26}
...
\paragraph{Source Code}\label{source-code-37}
...
\paragraph{Parameters}\label{parameters-39}
...
\paragraph{Details}\label{details-27}
...
\paragraph{Source Code}\label{source-code-38}
...
\paragraph{Parameters}\label{parameters-40}
...
\paragraph{Details}\label{details-28}
...
\paragraph{Source Code}\label{source-code-39}
...
\paragraph{Parameters}\label{parameters-41}
...
\paragraph{Details}\label{details-29}
...
\paragraph{Source Code}\label{source-code-40}
...
\paragraph{Parameters}\label{parameters-42}
...
\paragraph{Details}\label{details-30}
...
\paragraph{Source Code}\label{source-code-41}
...
\paragraph{Parameters}\label{parameters-43}
...
\paragraph{Details}\label{details-31}
...
\paragraph{Source Code}\label{source-code-42}
