...
Plots a graph based on the dataset passed in the \hyperref[func.mean_reg.params.data]{data} parameter, using both points and a line.
...
\phantomsection\label{func.mean_reg.params.data}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{func.mean_reg.params.title}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{func.mean_reg.params.xname}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{func.mean_reg.params.yname}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{func.mean_reg.params.xlabel}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{func.mean_reg.params.ylabel}
\begin{itemize}
\tightlist
\item
