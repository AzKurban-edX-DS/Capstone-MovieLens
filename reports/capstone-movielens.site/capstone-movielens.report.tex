...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-71-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-75-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-86-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-90-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-97-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-118-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-129-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-171-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-173-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-217-1.pdf}}
...
This is a helper function that calculates the \emph{date general effect} of the user ratings and is intended to be used in other functions and scripts (for instance in \hyperref[func.train_UMGY_effect]{train\_UMGY\_effect}) described below.
...
\begin{noteblock}
The complete version of the source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L2}{calc\_date\_general\_effect} function is available in the \hyperref[L1]{UMGYE Model Support Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L2}{UMGY-effect.functions.R} script on \emph{GitHub}.

\end{noteblock}

\subparagraph{Return}\label{return}

A data structure containg information about \emph{Date General Effect}.
...
This is a helper function that calculates the \emph{date general effect} of the user ratings using the \emph{5-Fold Cross Validation} method and is intended to be used in other functions and scripts (for instance in \hyperref[func.train_UMGY_effect.cv]{train\_UMGY\_effect.cv}) described below.
...
A data structure containg information about \emph{Date General Effect} as result of \emph{5-Fold Cross Validation}.
...
This is a helper function that calculates the \emph{UMGY effect} of the user ratings and is intended to be used in other functions and scripts (for instance in \hyperref[func.train_UMGY_effect]{train\_UMGY\_effect}) described below.
...
A data structure containg information about \emph{User+Movie+Genre+Year (UMGY) Effect}.
...
where \(n_r\) is the number of ratings made in year \(r\).
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-234-1.pdf}}
...
\subsubsection{Day Effect Analysis}\label{day-effect-analysis}
...
If we define \(d_{i,j}\) as the \emph{number of days since the earliest record} in the \texttt{edx} dataset for movie \(j\) rated by user \(i\), then the formula @res(eq:UMGYE-model) describing the \emph{UMGYE Model}, for the current model, takes the form:
...
with \(s\) a smooth function of \(d_{i,j}\)

Therefore, the formula @res(eq:year-effect) for calculation the prediction of a \emph{year effect} as a residual, for a \emph{smoothed day effect}
\[
\hat{f} = s(d_{i,j}) + \varepsilon_{i,j}
\]
...
\subsubsection{UMGYDE Model: Support Functions}\label{umgyde-model-support-functions}
...
\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L69}{calc\_UMGYD\_effect} Function}{calc\_UMGYD\_effect Function}}\label{func.calc_UMGYD_effect}

\hfill\break

This is a helper function that calculates the \emph{UMGYD effect} of the user ratings and is intended to be used in other functions and scripts (for instance in \hyperref[func.train_UMGYD_effect]{train\_UMGYD\_effect}) described below.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_UMGYD\_effect }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(date\_general\_effect)\{}
\NormalTok{  date\_general\_effect }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{group\_by}\NormalTok{(year) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{summarise}\NormalTok{(}\AttributeTok{ye =} \FunctionTok{mean}\NormalTok{(de, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{))}
\NormalTok{\}}
...
\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L69}{calc\_UMGYD\_effect} function is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L1}{UMGYDE Model Support Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L69}{UMGYD-effect.functions.R} script on \emph{GitHub}.

\end{noteblock}

\subparagraph{Return}\label{return-5}

A data structure containg information about \emph{User+Movie+Genre+Year (UMGYD) Effect}.

\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L74}{train\_UMGYD\_effect} Function}{train\_UMGYD\_effect Function}}\label{func.train_UMGYD_effect}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train\_UMGYD\_effect }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(train\_set, }\AttributeTok{lambda =} \DecValTok{0}\NormalTok{)\{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{is.na}\NormalTok{(lambda)) \{}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"Function: train\_UMGYD\_effect}
\StringTok{\textasciigrave{}lambda\textasciigrave{} is \textasciigrave{}NA\textasciigrave{}"}\NormalTok{)}
\NormalTok{  \}}
  
\NormalTok{  train\_set }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{calc\_date\_general\_effect}\NormalTok{(lambda) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{calc\_UMGYD\_effect}\NormalTok{()}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L74}{train\_UMGYD\_effect} function is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L1}{UMGYDE Model Support Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L74}{UMGYD-effect.functions.R} script on \emph{GitHub}.
...
\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L84}{train\_UMGYD\_effect.cv} Function}{train\_UMGYD\_effect.cv Function}}\label{func.train_UMGYD_effect.cv}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train\_UMGYD\_effect.cv }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(}\AttributeTok{lambda =} \DecValTok{0}\NormalTok{)\{}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{is.na}\NormalTok{(lambda)) \{}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"Function: train\_UMGYD\_effect.cv}
\StringTok{\textasciigrave{}lambda\textasciigrave{} is \textasciigrave{}NA\textasciigrave{}"}\NormalTok{)}
\NormalTok{  \}}
  
  \FunctionTok{calc\_date\_general\_effect.cv}\NormalTok{(lambda) }\SpecialCharTok{|\textgreater{}} \FunctionTok{calc\_UMGYD\_effect}\NormalTok{()  }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\begin{noteblock}
The source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L84}{train\_UMGYD\_effect.cv} function is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L1}{UMGYDE Model Support Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L84}{UMGYD-effect.functions.R} script on \emph{GitHub}.
...
\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L92}{calc\_UMGYD\_effect\_MSE} Function}{calc\_UMGYD\_effect\_MSE Function}}\label{func.calc_UMGYD_effect_MSE}

\hfill\break

The function calculates the \emph{Mean Squared Error (MSE)} of the \emph{UMGYDE Model} for the given \emph{Test Set} passed in the \texttt{test\_set} parameter.
...
\tightlist
\item
  \textbf{test\_set:} A \emph{Test Set} dataset used for \emph{UMGYDE Model} validation;
\item
  \textbf{UMGYD\_effect:} A data structure returned by any of the following functions described above:

  \begin{itemize}
  \tightlist
  \item
    \hyperref[func.train_UMGYD_effect]{calc\_UMGYD\_effect};
  \item
    \hyperref[func.train_UMGYD_effect]{train\_UMGYD\_effect};
  \item
    \hyperref[func.train_UMGYD_effect.cv]{train\_UMGYD\_effect.cv}.
  \end{itemize}
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_UMGYD\_effect\_MSE }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(test\_set, UMGYD\_effect)\{}
\NormalTok{  test\_set }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(edx.user\_effect, }\AttributeTok{by =} \StringTok{"userId"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(rglr.UM\_effect, }\AttributeTok{by =} \StringTok{"movieId"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(rglr.UMG\_effect, }\AttributeTok{by =} \StringTok{"movieId"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(date\_days\_map, }\AttributeTok{by =} \StringTok{"timestamp"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{left\_join}\NormalTok{(UMGYD\_effect, }\AttributeTok{by=}\StringTok{\textquotesingle{}year\textquotesingle{}}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{resid =}\NormalTok{ rating }\SpecialCharTok{{-}} \FunctionTok{clamp}\NormalTok{(mu }\SpecialCharTok{+}\NormalTok{ a }\SpecialCharTok{+}\NormalTok{ b }\SpecialCharTok{+}\NormalTok{ g }\SpecialCharTok{+}\NormalTok{ ye)) }\SpecialCharTok{|\textgreater{}} 
    \FunctionTok{pull}\NormalTok{(resid) }\SpecialCharTok{|\textgreater{}} \FunctionTok{mse}\NormalTok{()}
\NormalTok{\}}
\end{Highlighting}
...
\begin{noteblock}
The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L92}{calc\_UMGYD\_effect\_MSE} is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L92}{UMGYDE Model Support Functions} script.

\end{noteblock}

\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L102}{calc\_UMGYD\_effect\_MSE.cv} Function}{calc\_UMGYD\_effect\_MSE.cv Function}}\label{func.calc_UMGYD_effect_MSE.cv}

\hfill\break

The function calculates the \emph{5-Fold Cross Validation MSE} result for the \emph{UMGYD Effect} data passed in the \texttt{UMGYD\_effect} parameter.

\subparagraph{Parameters}\label{parameters-7}

\hfill\break

The function accepts the only parameter: \texttt{UMGYD\_effect}, which is a data structure returned by the one of the following functions described above:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_UMGYD\_effect\_MSE.cv }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(UMGYD\_effect)\{}
\NormalTok{  start }\OtherTok{\textless{}{-}} \FunctionTok{put\_start\_date}\NormalTok{()}
\NormalTok{  UMGYD\_effect\_MSEs }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(edx\_CV, }\ControlFlowTok{function}\NormalTok{(cv\_fold\_dat)\{}
\NormalTok{    cv\_fold\_dat}\SpecialCharTok{$}\NormalTok{validation\_set }\SpecialCharTok{|\textgreater{}} \FunctionTok{calc\_UMGYD\_effect\_MSE}\NormalTok{(UMGYD\_effect)}
\NormalTok{  \})}
  \FunctionTok{put\_end\_date}\NormalTok{(start)}
  \FunctionTok{put\_log1}\NormalTok{(}\StringTok{"Function: calc\_UMGYD\_effect\_MSE.cv}
\StringTok{Date (Year) Effect MSE values have been computed for the \%1{-}Fold Cross Validation samples."}\NormalTok{, }
\NormalTok{           CVFolds\_N)}
  
  \FunctionTok{mean}\NormalTok{(UMGYD\_effect\_MSEs)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\begin{noteblock}
The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L102}{calc\_UMGYD\_effect\_MSE.cv} is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L102}{UMGYDE Model Support Functions} script.

\end{noteblock}

\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L114}{calc\_UMGYD\_effect\_RMSE} Function}{calc\_UMGYD\_effect\_RMSE Function}}\label{func.calc_UMGYD_effect_RMSE}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_UMGYD\_effect\_RMSE }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(test\_set, UMGYD\_effect)\{}
\NormalTok{  mse }\OtherTok{\textless{}{-}}\NormalTok{ test\_set }\SpecialCharTok{|\textgreater{}} \FunctionTok{calc\_UMGYD\_effect\_MSE}\NormalTok{(UMGYD\_effect)}
  \FunctionTok{sqrt}\NormalTok{(mse)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{noteblock}
The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L114}{calc\_UMGYD\_effect\_RMSE} is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L114}{UMGYDE Model Support Functions} script.

\end{noteblock}

\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L118}{calc\_UMGYD\_effect\_RMSE.cv} Function}{calc\_UMGYD\_effect\_RMSE.cv Function}}\label{func.calc_UMGYD_effect_RMSE.cv}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calc\_UMGYD\_effect\_RMSE.cv }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(UMGYD\_effect)\{}
\NormalTok{  UMGYD\_effect\_RMSE }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{calc\_UMGYD\_effect\_MSE.cv}\NormalTok{(UMGYD\_effect))}
  \FunctionTok{put\_log2}\NormalTok{(}\StringTok{"\%1{-}Fold Cross Validation ultimate RMSE: \%2"}\NormalTok{, }
\NormalTok{           CVFolds\_N, }
\NormalTok{           UMGYD\_effect\_RMSE)}
...
\begin{noteblock}
The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L118}{calc\_UMGYD\_effect\_RMSE.cv} is also available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L118}{UMGYDE Model Support Functions} script.

\end{noteblock}

\newpage

\subsubsection{UMGYDE Model Building}\label{umgyde-model-building}

\hfill\break

\begin{noteblock}
The complete source code of building and training the current model is available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1432}{UMGYDE Model Building} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1432}{capstone-movielens.main.R} script on \emph{GitHub}.
...
\begin{noteblock}
We use the \hyperref[func.train_UMGYD_effect.cv]{train\_UMGYD\_effect.cv} function described above to compute the \emph{UMGYD Effect}.

\end{noteblock}

We can now construct predictors and calculate the \emph{RMSE} of the current model using the \hyperref[func.calc_UMGYD_effect_RMSE.cv]{calc\_UMGYD\_effect\_RMSE.cv} function described above:
...
We have already explained the idea of \emph{Linear Model Regularization} in the \hyperref[ume-model-regularization]{UME Model Regularization} section above. We have also seen how the formula @res(eq:ME-penalty) for adding a penalty to the \emph{UME Model} is transformed into the formula @res(eq:GE-penalty) for the \emph{UMGE Model} and then into the formula @res(eq:GYE-penalty) for the \emph{UMGYE Model}. For the current model, this formula takes the form:
...
And the formula @res(eq:ME-regularized) for calculating the values of the \emph{treatment effect} that minimizes the equation will take the form:

\begin{equation}
\hat{\gamma}(v_{i,j}, \lambda) = \frac{1}{\lambda + n_v} \sum_{r=1}^{n_v} \left(Y_{i,j} - \mu - \alpha_i - \beta_j - g_{i,j} - \gamma(v_{i,j})\right)
\label{eq:DE0-regularized}
\end{equation}
...
\NormalTok{\textbackslash{}hat\{s\}(d\_\{i,j, \textbackslash{}lambda}\ErrorTok{)} \OtherTok{=}\NormalTok{ \textbackslash{}frac\{}\DecValTok{1}\NormalTok{\}\{\textbackslash{}lambda }\SpecialCharTok{+}\NormalTok{ n\_d\} \textbackslash{}sum\_\{r}\OtherTok{=}\DecValTok{1}\NormalTok{\}}\SpecialCharTok{\^{}}\NormalTok{\{n\_\{d\}\} \textbackslash{}}\FunctionTok{left}\NormalTok{(Y\_\{i,j\} }\SpecialCharTok{{-}}\NormalTok{ \textbackslash{}mu }\SpecialCharTok{{-}}\NormalTok{ \textbackslash{}alpha\_i }\SpecialCharTok{{-}}\NormalTok{ \textbackslash{}beta\_j }\SpecialCharTok{{-}}\NormalTok{ g\_\{i,j\} }\SpecialCharTok{{-}}\NormalTok{ \textbackslash{}}\FunctionTok{gamma}\NormalTok{(v\_\{i,j\})\textbackslash{}right)}
\NormalTok{(\textbackslash{}}\CommentTok{\#eq:DE{-}regularized)}
\CommentTok{\# \textbackslash{}end\{equation\}}
\end{Highlighting}
\end{Shaded}
...
\paragraph{UMGYDE Model Regularization: Support Functions}\label{umgyde-model-regularization-support-functions}

\hfill\break

\begin{noteblock}
The \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L128}{regularize.test\_lambda.UMGYD\_effect.cv} function described below are defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L127}{Regularization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L128}{UM-effect.functions.R} script.

\end{noteblock}

\subparagraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#128}{regularize.test\_lambda.UMGYD\_effect.cv} Function}{regularize.test\_lambda.UMGYD\_effect.cv Function}}\label{func.regularize.test_lambda.UMGYD_effect.cv}

\hfill\break

This function calculates \emph{RMSE} of the \emph{UMGYDE Model} using \emph{5-Fold Cross Validation} for the given \(\lambda\) parameter value:

\begin{noteblock}
Note that we reuse the function \hyperref[func.train_UMGYD_effect.cv]{train\_UMGYD\_effect.cv} calling it from the \hyperref[func.regularize.test_lambda.UMGYD_effect.cv]{regularize.test\_lambda.UMGYD\_effect.cv}, but now with the \(\lambda\) parameter different from the default (`lambda = 0') value.
...
\begin{noteblock}
The complete version of the source code provided in this section can be found in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1493}{UMGYDE Model Regularization: Pre-configuration} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1493}{capstone-movielens.main.R} script on \emph{GitHub}.
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-280-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-283-1.pdf}}
...
\begin{noteblock}
The complete version of the source code provided in this section are available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1589}{Re-train Regularized UMGYDE Model for the best \texttt{lambda}} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L1589}{capstone-movielens.main.R} script on \emph{GitHub}.

\end{noteblock}

Now, we can calculate the \emph{Regularized UMGYDE Effect} by retraining our model on the entire \texttt{edx} dataset with the best value of the \(\lambda\) parameter we just calculated, for the definitive \emph{Root Mean Squared Error} calculation and use in subsequent models.

\begin{noteblock}
Here we use the helper function \hyperref[func.train_UMGYD_effect]{train\_UMGYD\_effect} described above in the \hyperref[umgyde-model-regularization-support-functions]{UMGYDE Model Regularization: Support Functions} section.

\end{noteblock}

We calculate the \emph{Root Mean Squared Error} for the ultimately computed \emph{UMGYDE Effect} using the helper function \hyperref[func.calc_UMGYD_effect_RMSE.cv]{calc\_UMGYD\_effect\_RMSE.cv} described above in the \hyperref[umgyde-model-regularization-support-functions]{UMGYDE Model Regularization: Support Functions} section as follows:
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-15}
...
\subsubsection{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R\#L80}{get\_fine\_tune.param.endpoints} Function}{get\_fine\_tune.param.endpoints Function}}\label{func.get_fine_tune.param.endpoints}
...
\subparagraph{\texorpdfstring{\textbf{\emph{preset.result}}}{preset.result}}\label{preset.result-1}
...
\paragraph{Parameters}\label{parameters-21}
...
\paragraph{Source Code}\label{source-code-21}
...
\paragraph{Parameters}\label{parameters-22}
...
\paragraph{Source Code}\label{source-code-22}
...
\paragraph{Parameters}\label{parameters-23}
...
\paragraph{Source Code}\label{source-code-23}
...
\paragraph{Parameters}\label{parameters-28}
...
\paragraph{Source Code}\label{source-code-28}
...
\paragraph{Parameters}\label{parameters-29}
...
\paragraph{Source Code}\label{source-code-29}
...
\paragraph{Parameters}\label{parameters-30}
...
\paragraph{Source Code}\label{source-code-30}
...
\paragraph{Signature}\label{signature-16}

\hfill\break

\phantomsection\label{func.fname8.params}
\paragraph{Parameters}\label{parameters-31}
...
\paragraph{Details}\label{details-21}
...
\paragraph{Value}\label{value-20}

\hfill\break

\phantomsection\label{func.fname8.code}
\paragraph{Source Code}\label{source-code-31}
