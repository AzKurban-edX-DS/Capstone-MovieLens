...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-28-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-32-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-107-1.pdf}}
...
\begin{noteblock}
The full source code of the functions described in this section is available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L1}{User+Movie Effect Model Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R} script on \emph{GitHub}.
...
\begin{noteblock}
The function described above accepts the \texttt{lambda} parameter, which we will need later for the \emph{Regularization} method. We also use the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R\#L63}{mean\_reg} function call, which we will also need later for the \emph{Regularization} techniques (For details, see the \hyperref[func.mean_reg]{mean\_reg} function description in the \hyperref[appendix.a]{Appendix} of this report).
...
\begin{noteblock}
Here we use the function call \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R\#L432}{union\_cv\_results}, which is defined in the script \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R}{common-helper.functions.R}, to aggregate the \texttt{Cross\ Validation} results.
...
The code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L55}{calc\_user\_movie\_effect\_MSE} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R}{UM-effect.functions.R} script to calculate the \texttt{Mean\ Squared\ Error\ (MSE)} of the \texttt{UME\ Model} for the given \texttt{Test\ Set} is provided below:
...
\paragraph{\texorpdfstring{\texttt{calc\_user\_movie\_effect\_RMSE.cv} Function}{calc\_user\_movie\_effect\_RMSE.cv Function}}\label{calc_user_movie_effect_rmse.cv-function}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-131-1.pdf}}
...
\subsubsection{Regularizing User+Movie Effect Model}\label{regularizing-usermovie-effect-model}
...
\item
  \textbf{Preconfiguration:} Preliminary determination of the optimal range of \(\lambda\) values for the \texttt{5-Fold\ Cross\ Validation} samples;
\item
...
\subparagraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R\#L96}{regularize.test\_lambda.UM\_effect.cv} Function}{regularize.test\_lambda.UM\_effect.cv Function}}\label{regularize.test_lambda.um_effect.cv-function}
...
\begin{noteblock}
Note that we reuse the function \href{}{train\_user\_movie\_effect.cv} calling it from the \href{}{regularize.test\_lambda.UM\_effect.cv}, but now with the \(\lambda\) parameter different from the default (zero) value.
...
Finally, let's verify that the penalized estimates \(\hat{b}_i(\lambda)\) we have just computed actually result in the minimal \emph{RMSE} figured out above:
...
\paragraph{User+Movie Effect Model Tuning: Preconfiguratioin}\label{usermovie-effect-model-tuning-preconfiguratioin}

We are going to use the \hyperref[func.tune.model_param]{tune.model\_param} function described in the \hyperref[appendix.a]{Appendix} of this report.
...
\begin{noteblock}
The complete version of the code provided in this section can be found in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L814}{Process Preliminary setting-up of lambda range for UM Effect regularization} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R}{capstone-movielens.main.R} script.

\end{noteblock}

\newpage

\paragraph{User+Movie Effect Model: Fine-Tuning}\label{usermovie-effect-model-fine-tuning}
...
\subsection{Regularization: Common Helper Functions}\label{regularization-common-helper-functions}
...
\paragraph{Sugnature}\label{sugnature}
...
\paragraph{Sugnature}\label{sugnature-1}
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-2}
...
\paragraph{Sugnature}\label{sugnature-2}
...
\paragraph{Sugnature}\label{sugnature-3}
...
\subsubsection{\texorpdfstring{\href{}{func.00} Function}{func.00 Function}}\label{func.00}

\hfill\break

\phantomsection\label{func.00.signature}
\paragraph{Sugnature}\label{sugnature-4}

\hfill\break

\phantomsection\label{func.00.params}
...
\phantomsection\label{func.00.details}
...
\phantomsection\label{func.00.value}
\paragraph{Value}\label{value-5}

\hfill\break

\phantomsection\label{func.00.code}
...
\subsubsection{\texorpdfstring{\href{}{func} Function}{func Function}}\label{func.01}

\hfill\break

\phantomsection\label{func.01.signature}
\paragraph{Sugnature}\label{sugnature-5}

\hfill\break

\phantomsection\label{func.01.params}
...
\phantomsection\label{func.01.details}
...
\phantomsection\label{func.01.value}
\paragraph{Value}\label{value-6}

\hfill\break

\phantomsection\label{func.01.code}
...
\subsubsection{\texorpdfstring{\href{}{func} Function}{func Function}}\label{func.02}

\hfill\break

\phantomsection\label{func.02.signature}
\paragraph{Sugnature}\label{sugnature-6}

\hfill\break

\phantomsection\label{func.02.params}
...
\phantomsection\label{func.02.details}
...
\phantomsection\label{func.02.value}
\paragraph{Value}\label{value-7}

\hfill\break

\phantomsection\label{func.02.code}
...
\subsubsection{\texorpdfstring{\href{}{func.0} Function}{func.0 Function}}\label{func.0}

\hfill\break

\phantomsection\label{func.0.signature}
\paragraph{Sugnature}\label{sugnature-7}

\hfill\break

\phantomsection\label{func.0.params}
...
\phantomsection\label{func.0.details}
...
\phantomsection\label{func.0.value}
\paragraph{Value}\label{value-8}

\hfill\break

\phantomsection\label{func.0.code}
...
\subsubsection{\texorpdfstring{\href{}{func1} Function}{func1 Function}}\label{func.03}

\hfill\break

\phantomsection\label{func.03.signature}
\paragraph{Sugnature}\label{sugnature-8}

\hfill\break

\phantomsection\label{func.03.params}
...
\phantomsection\label{func.03.details}
...
\phantomsection\label{func.03.value}
\paragraph{Value}\label{value-9}

\hfill\break

\phantomsection\label{func.03.code}
...
\subsubsection{\texorpdfstring{\href{}{func1} Function}{func1 Function}}\label{func.1}

\hfill\break

\phantomsection\label{func.1.signature}
\paragraph{Sugnature}\label{sugnature-9}

\hfill\break

\phantomsection\label{func.1.params}
...
\phantomsection\label{func.1.details}
...
\phantomsection\label{func.1.value}
\paragraph{Value}\label{value-10}

\hfill\break

\phantomsection\label{func.1.code}
...
\subsubsection{\texorpdfstring{\href{}{func.2} Function}{func.2 Function}}\label{func.2}

\hfill\break

\phantomsection\label{func.2.signature}
\paragraph{Sugnature}\label{sugnature-10}

\hfill\break

\phantomsection\label{func.2.params}
...
\phantomsection\label{func.2.details}
...
\phantomsection\label{func.2.value}
\paragraph{Value}\label{value-11}

\hfill\break

\phantomsection\label{func.2.code}
...
\subsubsection{\texorpdfstring{\href{}{func.3} Function}{func.3 Function}}\label{func.3}

\hfill\break

\phantomsection\label{func.3.signature}
\paragraph{Sugnature}\label{sugnature-11}

\hfill\break

\phantomsection\label{func.3.params}
...
\phantomsection\label{func.3.details}
...
\phantomsection\label{func.3.value}
\paragraph{Value}\label{value-12}

\hfill\break

\phantomsection\label{func.3.code}
...
\subsubsection{\texorpdfstring{\href{}{func.4} Function}{func.4 Function}}\label{func.4}

\hfill\break

\phantomsection\label{func.4.signature}
\paragraph{Sugnature}\label{sugnature-12}

\hfill\break

\phantomsection\label{func.4.params}
...
\phantomsection\label{func.4.details}
...
\phantomsection\label{func.4.value}
\paragraph{Value}\label{value-13}

\hfill\break

\phantomsection\label{func.4.code}
...
\subsubsection{\texorpdfstring{\href{}{func.5} Function}{func.5 Function}}\label{func.5}

\hfill\break

\phantomsection\label{func.5.signature}
\paragraph{Sugnature}\label{sugnature-13}

\hfill\break

\phantomsection\label{func.5.params}
...
\phantomsection\label{func.5.details}
...
\phantomsection\label{func.5.value}
\paragraph{Value}\label{value-14}

\hfill\break

\phantomsection\label{func.5.code}
...
\subsubsection{\texorpdfstring{\href{}{func.6} Function}{func.6 Function}}\label{func.6}

\hfill\break

\phantomsection\label{func.6.signature}
\paragraph{Sugnature}\label{sugnature-14}

\hfill\break

\phantomsection\label{func.6.params}
...
\phantomsection\label{func.6.details}
...
\phantomsection\label{func.6.value}
\paragraph{Value}\label{value-15}

\hfill\break

\phantomsection\label{func.6.code}
...
\subsubsection{\texorpdfstring{\href{}{func.7} Function}{func.7 Function}}\label{func.7}

\hfill\break

\phantomsection\label{func.7.signature}
\paragraph{Sugnature}\label{sugnature-15}

\hfill\break

\phantomsection\label{func.7.params}
...
\phantomsection\label{func.7.details}
...
\phantomsection\label{func.7.value}
\paragraph{Value}\label{value-16}

\hfill\break

\phantomsection\label{func.7.code}
...
\subsubsection{\texorpdfstring{\href{}{func.8} Function}{func.8 Function}}\label{func.8}

\hfill\break

\phantomsection\label{func.8.signature}
\paragraph{Sugnature}\label{sugnature-16}

\hfill\break

\phantomsection\label{func.8.params}
...
\phantomsection\label{func.8.details}
...
\phantomsection\label{func.8.value}
\paragraph{Value}\label{value-17}

\hfill\break

\phantomsection\label{func.8.code}
...
\subsubsection{\texorpdfstring{\href{}{} Function}{ Function}}\label{func.3-1}

\hfill\break

\paragraph{Sugnature}\label{sugnature-17}
...
\hfill\break
Below is the most significant part of the code of the \href{}{function} function:
...
See the \texttt{func.model.tune.param\_range} Function description \hyperref[func.model.tune.param_range]{above}.
