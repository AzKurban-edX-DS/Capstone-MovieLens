...
\begin{verbatim}
## Loading required package: edx.capstone.movielens.data
\end{verbatim}
...
\begin{tabular}{>{\raggedright\arraybackslash}p{35em}>{\centering\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{50em}}
\toprule
...
\begin{noteblock}
The complete version of the source code of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L2}{calc\_day\_general\_effect} function is available in the {[}UMGYDE Model Support Functions{]}((\url{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L1}) section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGYD-effect.functions.R\#L2}{UMGYD-effect.functions.R} script on \emph{GitHub}.

\end{noteblock}

\subparagraph{Return}\label{return-5}

A data structure containing information about \emph{Day General Effect}.
...
\hfill\break
The \emph{day general effect} data, which is a data structure returned by any of the following functions described above:
...
The function is a wrapper to the {[}stats::loess{]} and calls it under the hood.
...
A data structure containing information about \emph{User+Movie+Genre+Year (UMGYD) Effect}.
...
This is a helper function that calculates the \emph{UMGYD Effect} of the user ratings and is intended to be used in other functions and scripts (such as \hyperref[func.train_UMGYD_effect]{train\_UMGYD\_effect}) described below.
...
\NormalTok{  \}}
  ...
  \FunctionTok{calc\_day\_general\_effect.cv}\NormalTok{(lambda) }\SpecialCharTok{|\textgreater{}} \FunctionTok{calc\_UMGYD\_effect}\NormalTok{()  }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-285-1.pdf}}
...
\paragraph{Details}\label{details-5}
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-16}
...
\paragraph{Parameters}\label{parameters-32}
...
\paragraph{Details}\label{details-22}
...
\paragraph{Source Code}\label{source-code-32}
