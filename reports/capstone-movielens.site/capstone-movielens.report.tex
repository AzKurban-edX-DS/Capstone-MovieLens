...
\hfill\break
The \emph{Root Mean Squared Error (RMSE)} value of the \emph{UMGYDE Model} computed as the square root of the \emph{5-Fold Cross Validation MSE} result.
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-286-1.pdf}}
...
\paragraph{\texorpdfstring{\textbf{Parameters}}{Parameters}}\label{parameters-21}
