...
\begin{noteblock}
Further analysis of the \texttt{edx} dataset was also inspired by the article \href{https://www.kaggle.com/code/amirmotefaker/movie-recommendation-system-using-r-best/notebook}{Movie Recommendation System using R - BEST} written by \href{https://www.kaggle.com/amirmotefaker}{Amir Moterfaker}\autocite{MRS-R-BEST}, from which the code and explanatory notes below were cited.
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-22-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-25-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-26-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-29-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-87-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-104-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-109-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-111-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-127-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-136-1.pdf}}
\newpage
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-166-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-167-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-169-1.pdf}}
...
In this case, the formula \eqref{eq:ME-penalty} for adding a penalty takes the following form:
...
And the formula \eqref{eq:ME-regularized} for calculating the values of the \emph{genre effect} that minimize the equation takes the following form:
...
As stated in the \hyperref[ume-model-regularization]{UME Model Regularization} section, we will implement the \emph{Regularization} method on our current model in three steps:
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-183-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{capstone-movielens.report_files/figure-latex/unnamed-chunk-186-1.pdf}}
\newpage
...
\begin{noteblock}
As we can see, the current model still does not show much improvement after \emph{regularization}, even though the data analysis we made in the \hyperref[movie-genres-effect]{Movie Genres Effect} section showed strong evidence of a genre effect.
...
If we define \(\gamma(q)\) as the \emph{year effect} for the year (which is denotes by \(q\) here) of rating a movie \(j\) by a user \(i\), the formula \eqref{eq:UMGE-model} describing the \emph{UMGE Model}, for the current model, takes the following form:
...
\begin{noteblock}
The complete source code of the functions described in this section is available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L1}{UMGYE Model Support Functions} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R}{} script on \emph{GitHub}.

\end{noteblock}

\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L}{} Function}{ Function}}\label{func.}
...
\NormalTok{  dg\_effect }\OtherTok{\textless{}{-}}\NormalTok{ train\_set }\SpecialCharTok{|\textgreater{}} 
    ...
    \CommentTok{\# filter(!is.na(resid)) |\textgreater{}}
...
\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L73}{calc\_UMGY\_effect} Function}{calc\_UMGY\_effect Function}}\label{func.calc_UMGY_effect}
...
\paragraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L78}{train\_UMGY\_effect} Function}{train\_UMGY\_effect Function}}\label{func.train_UMGY_effect}
...
\begin{noteblock}
This function accepts the \texttt{lambda} parameter, which we will need later for the \emph{Model Regularization} method. We also use the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R\#L63}{mean\_reg} function call, which we will need later for the \emph{Regularization} techniques (for details, see the \hyperref[func.mean_reg]{mean\_reg} function description in the Section \hyperref[appndx_a.rglr.common_helper.functions]{Regularization: Common Helper Functions} section of the \hyperref[appndx_a]{Appendix} to this report).
We have already explained that in the \hyperref[umgye-effect-model-regularization]{UMGYE Effect Model Regularization} section.
For now, we omit the \texttt{lambda} parameter, accepting its default value \texttt{lambda\ =\ 0}. Let's recall that in this case, the \hyperref[func.mean_reg]{mean\_reg} function is equivalent to the standard R function \href{https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/mean}{base::mean}.

\end{noteblock}

\paragraph{\texorpdfstring{\texttt{train\_UMGY\_effect.cv} Function}{train\_UMGY\_effect.cv Function}}\label{func.train_UMGY_effect.cv}

\hfill\break

We use the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L59}{train\_UMGY\_effect.cv} function to build and train our model using the \texttt{5-Fold\ Cross\ Validation} method. Below, we provide a slightly simplified version of the source code of that function:
...
\paragraph{\texorpdfstring{\texttt{calc\_UMGY\_effect\_MSE} Function}{calc\_UMGY\_effect\_MSE Function}}\label{calc_umgy_effect_mse-function}

\hfill\break

The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L}{calc\_UMGY\_effect\_MSE} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/}{} script to calculate the \emph{Mean Squared Error (MSE)} of the \emph{UMGYE Model} for the given \emph{Test Set} is provided below:

\newpage

\paragraph{\texorpdfstring{\texttt{calc\_UMGY\_effect\_MSE.cv} Function}{calc\_UMGY\_effect\_MSE.cv Function}}\label{calc_umgy_effect_mse.cv-function}

\hfill\break

The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L}{calc\_UMGY\_effect\_MSE.cv} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/}{} script to calculate the \emph{5-Fold Cross Validation MSE} result of the \emph{UMGYE Model} is provided below:

\paragraph{\texorpdfstring{\texttt{calc\_UMGY\_effect\_RMSE} Function}{calc\_UMGY\_effect\_RMSE Function}}\label{calc_umgy_effect_rmse-function}

\hfill\break

The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L118}{calc\_UMGY\_effect\_RMSE} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/}{} script to calculate the \emph{Root Mean Squared Error (RMSE)} of the \emph{UMGYE Model} for the given \emph{Test Set} is provided below:

\paragraph{\texorpdfstring{\texttt{calc\_UMGY\_effect\_RMSE.cv} Function}{calc\_UMGY\_effect\_RMSE.cv Function}}\label{func.calc_UMGY_effect_RMSE.cv}

\hfill\break

The source code of the function \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L}{calc\_UMGY\_effect\_RMSE.cv} defined in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/}{} script to calculate the \emph{5-Fold Cross Validation \textbf{RMSE}} result of the \emph{UMGYE Model} is provided below:
...
\begin{noteblock}
The complete source code of builing and training the current model is available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L}{Model building: UMGYE Effect} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R}{capstone-movielens.main.R} script on \emph{GitHub}.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv.UMG\_effect.RMSE }\OtherTok{\textless{}{-}} \FunctionTok{calc\_UMGY\_effect\_RMSE.cv}\NormalTok{(cv.UMG\_effect)}

\NormalTok{RMSEs.ResultTibble.UMGYE }\OtherTok{\textless{}{-}}\NormalTok{ RMSEs.ResultTibble.rglr.UMGYE }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{RMSEs.AddRow}\NormalTok{(}\StringTok{"UMGYE Effect (UMGYE) Model"}\NormalTok{, cv.UMG\_effect.RMSE,}
               \AttributeTok{comment =} \StringTok{"Comment"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{UMGYE Effect Model Regularization}\label{umgye-effect-model-regularization}
...
And the formula \eqref{eq:ME-regularized} for calculating the values of the \emph{treatment effect} that minimize the equation takes the following form:
...
\begin{noteblock}
The \href{}{regularize.test\_lambda.UMGY\_effect.cv} function described below are defined in the \href{}{Regularization} section of the \href{}{UM-effect.functions.R} script.

\end{noteblock}

\subparagraph{\texorpdfstring{\href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UMGY-effect.functions.R\#L96}{regularize.test\_lambda.UMGY\_effect.cv} Function}{regularize.test\_lambda.UMGY\_effect.cv Function}}\label{func.regularize.test_lambda.UMGY_effect.cv}

\hfill\break

This function calculates \emph{RMSE} of the \emph{UMGYE Model} using \emph{5-Fold Cross Validation} method for the given \(\lambda\) parameter value:
...
\begin{noteblock}
The complete version of the source code provided in this section can be found in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L}{UMGYE Model Regularization: Pre-configuration} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R}{capstone-movielens.main.R} script.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# title = TeX(r\textquotesingle{}[UMGE Model Regularization: $\textbackslash{}lambda$ Range Pre{-}configuration]\textquotesingle{})}
\end{Highlighting}
\end{Shaded}
...
\begin{noteblock}
The complete version of the source code provided in this section are available in the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L910}{Re-training Regularized UMGYE Effect Model for the best \(\lambda\)} section of the \href{https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R\#L910}{capstone-movielens.main.R} script on \emph{GitHub}.

\end{noteblock}

We calculate the \emph{Root Mean Squared Error} for the ultimately computed \emph{UMGYE Effect} using \hyperref[func.calc_UMGY_effect_RMSE.cv]{calc\_UMGY\_effect\_RMSE.cv} function described above as follows:
...
\NormalTok{RMSEs.ResultTibble.rglr.UMGYE }\OtherTok{\textless{}{-}}\NormalTok{ RMSEs.ResultTibble.UMGYE }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{RMSEs.AddRow}\NormalTok{(}\StringTok{"Regularized UMGYE Effect Model"}\NormalTok{, }
\NormalTok{               UMGYE.rglr.retrain.RMSE,}
               \AttributeTok{comment =} \StringTok{"Computed for \textasciigrave{}lambda\textasciigrave{} = \%1"} \SpecialCharTok{|\textgreater{}}
