...
::: {.noteblock data-latex=""}
In the code snippet above, we use the user-defined function [naive_model_MSEs](#func.naive_model_MSEs) described in the [Models Training: Support Functions]/[OMR Model: Helper Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
To print the log, we use the function [print_log1](#func.print_log1) described in the [Common Helper Functions]/[Logging Functions] section of [Appendix A](#appndx_a).
:::
