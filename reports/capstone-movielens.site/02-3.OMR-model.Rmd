...
Let's begin our analysis by evaluating the simplest model described in [Section 23.3 _A first model_](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/regularization.html#a-first-model) of the *Course Textbook*[@IDS2_23-3], and then gradually refine it through further research.
...
with $\varepsilon_{i,j}$ independent errors sampled from the same distribution centered at 0 and $\mu$ is the rating for all movies.
