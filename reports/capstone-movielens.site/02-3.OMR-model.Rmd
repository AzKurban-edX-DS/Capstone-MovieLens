...
::: {.noteblock data-latex=""}
In the code snippet above, we use the user-defined function [naive_model_MSEs](#func.naive_model_MSEs) described in the [OMR Model: Helper Functions] section of [Appendix A](#appndx_a) to calculate *RMSEs* for the sequence of the deviation values.
:::
...
::: {.noteblock data-latex=""}
In the code snippet above, we use the function [naive_model_RMSE](#func.naive_model_RMSE) described in the [Models Training: Support Functions] / [OMR Model: Helper Functions] section of [Appendix A](#appndx_a) to calculate *RMSEs* for the sequence of the deviation values.
:::
