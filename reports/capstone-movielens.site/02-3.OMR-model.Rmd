...
If we predict all unknown ratings with $\hat{\mu}$, we can obtain *RMSE* using the following [line of code](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L108): 
```{r main-script@L108 }
