...
Let's begin our analysis by evaluating the simplest model described in [Section 24.1 *Case study: recommendation systems / A first model*](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/regularization.html#a-first-model) of the *Course Textbook (New Edition)*[@IDS2_24-1], and then gradually refine it through further research.
...
::: {.noteblock data-latex=""}
In the code snippet above, we use the function [naive_model_RMSE](#func.naive_model_RMSE) described in the [OMR Model: Helper Functions] section of [Appendix A: Support Functions] to calculate *RMSEs* for the sequence of the deviation values.
:::
...
::: {.noteblock data-latex=""}
To print the log, we use the function [print_log1](#func.print_log1) described in the [Logging Functions] section of [Appendix A: Support Functions].
:::
