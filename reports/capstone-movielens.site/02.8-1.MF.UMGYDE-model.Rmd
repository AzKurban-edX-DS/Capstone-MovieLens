...
::: {.noteblock data-latex=""}
In the code snippet above, we use the [clamp](#func.clamp) user-defined function described in the [Common Helper Functions]/[Utility Functions] section of [Appendix A](#appndx_a).
:::
