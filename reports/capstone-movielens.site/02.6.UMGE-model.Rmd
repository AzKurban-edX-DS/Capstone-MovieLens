...
We have already explained the idea of the _Linear Model Regularization_ in the [UME Model Regularization] above. Let's extend the concept outlined there to our current model.
...
As we can see, the current model still does not show much improvement after _regularization_, even though the data analysis we made in the [Movie Genres Effect] showed strong evidence of a genre effect.
