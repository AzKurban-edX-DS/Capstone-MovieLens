...
As mentioned in [Chapter 24: *Regularization*, Section 24.4: *Exercises*](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/regularization.html#exercises) (*Exercises 9-15*) of the *Course Textbook* the `Movielens` dataset also has a genres column. This column includes every genre that applies to the movie (some movies fall under several genres)[@IDS2_24-4].
