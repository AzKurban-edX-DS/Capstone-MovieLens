...
Now, we can refine our _User+Movie+Genre Effect Model_ by retraining on the entire `edx` dataset with the best value of the $\lambda$ parameter we just figured out (let's call it *Regularized User+Movie+Genre Effect Model* or *Regularized UMGE Model* for short), for the definitive _RMSE_ calculation and use in subsequent models:
```{r, eval=FALSE}
