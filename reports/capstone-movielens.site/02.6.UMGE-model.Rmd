...
In the code snippet above, we use the following functions described in [Appendix A: Support Functions]: 
  ...
  - [calc_UMG_effect_RMSE.cv](#func.calc_UMG_effect_RMSE.cv) (described in the *Models Training: Support Functions /* [UMGE Model: Utility Functions] section) to calculate the *RMSE* for the *UMGE Model*;
