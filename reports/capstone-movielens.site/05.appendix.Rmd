...
This function internally uses the [base::union](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/sets) function to aggregate the _N-Fold Cross-Validation_ result data list into a single data frame for further processing. 
:::
...
Trains the *(Regularized) User+Movie (UM) Effect Model* using the the _5-Fold Cross Validation_ 
...
Under the hood, this function internally calls the [train_user_movie_effect](#func.train_user_movie_effect) function described above for every iteration of the _5-Fold Cross Validation_. It also calls internally the [union_cv_results](#func.union_cv_results) function described above in the *Data Helper Functions / [Models Training Functions]* section of this *Appendix* to aggregate the cross-validation results.

::: {.noteblock data-latex=""}
The *Regularization technique* (described in section [Section 24.1 *Case study: recommendation systems / Penalized Least Squares*](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/regularization.html#penalized-least-squares) of the _Course Textbook (New Edition)_[@IDS2_24-1]) is applied to the model being trained only when the *Regularization parameter* value, passed in the [lambda](#func.train_user_movie_effect.args.lambda) argument, is other than default (to be more exact, greater than zero).
:::
:::
...
Data frame representing the *UM Effect Model* trained (and also *regularized* if the [lambda](#func.train_user_movie_effect.args.lambda) argument value is other than the default) using _5-Fold Cross-Validation_.
:::
...
#### [calc_user_movie_effect_RMSE](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L53) Function {#func.calc_user_movie_effect_RMSE}
\

::: { #func.calc_user_movie_effect_RMSE.usage .sidebar }
##### Usage
\

```{r eval=FALSE}
calc_user_movie_effect_RMSE()

```
:::

::: { #func.calc_user_movie_effect_RMSE.args .sidebar }
##### Arguments
\
...
::: { #func.calc_user_movie_effect_RMSE.details .sidebar }
##### Details
\
...
::: { #func.calc_user_movie_effect_RMSE.value .sidebar }
##### Value
\

:::

::: { #func.calc_user_movie_effect_RMSE.code .sidebar }
##### Source Code
\

The source code of the [calc_user_movie_effect_RMSE](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L53) function is shown below:
```{r eval=FALSE}
```
...
#### [calc_user_movie_effect_MSE](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L57) Function {#func.calc_user_movie_effect_MSE}
\
...
The source code of the [calc_user_movie_effect_MSE](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L57) function is shown below:
```{r eval=FALSE}
```

::: {.noteblock data-latex=""}
The source code of the [calc_user_movie_effect_MSE](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L57) function is also available in the [UME Model Utility Functions](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L2) section of the [UM-effect.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L57) script on _GitHub_.
:::
:::

\newpage

#### [calc_user_movie_effect_RMSE.cv](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L67) Function {#func.calc_user_movie_effect_RMSE.cv}
\
...
```{r eval=FALSE}
calc_user_movie_effect_RMSE.cv()
...
The source code of the [calc_user_movie_effect_RMSE.cv](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L67) function is shown below:
```{r eval=FALSE}
```
...
#### [calc_user_movie_effect_MSE.cv](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L74) Function {#func.calc_user_movie_effect_MSE.cv}
\
...
The source code of the [calc_user_movie_effect_MSE.cv](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L74) function is shown below:
```{r eval=FALSE}
```

::: {.noteblock data-latex=""}
The source code of the [calc_user_movie_effect_MSE.cv](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L74) function is also available in the [UME Model Utility Functions](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L2) section of the [UM-effect.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/UM-effect.functions.R#L74) script on _GitHub_.
:::
:::
