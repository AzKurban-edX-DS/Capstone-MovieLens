...
Calculates *Mean Squared Error (MSE)* for the *UM Effect (UME) Model* produced by the [train_user_movie_effect.cv](#func.train_user_movie_effect.cv) function call.
...
Calculates *Mean Squared Error (MSE)* for the *UM Effect (UME) Model* (produced by the [train_user_movie_effect.cv](#func.train_user_movie_effect.cv) function call) using *N-Fold Cross-Validation*.
...
Calculates *Root Mean Squared Error (RMSE)* for the *UM Effect (UME) Model* (produced by the [train_user_movie_effect.cv](#func.train_user_movie_effect.cv) function call) using *N-Fold Cross-Validation*.
