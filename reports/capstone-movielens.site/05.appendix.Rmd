...
::: { #func.tune.model_param.args.steps.beyond_min .sidebar }
  - **steps.beyond_min:** (2 by default; only takes effect if [break.if_min](#func.tune.model_param.args.break.if_min) is `TRUE`) Specifies the number of steps after finding the minimum *RMSE* value after which the algorithm should terminate.
