...
::: {.noteblock data-latex=""}
We use the [splitGenreRows](#func.splitGenreRows) function (described in the [Data Processing Functions] section of the [Appendix A: Support Function]) to split rows of the original dataset.
:::
