...
This function is a wrapper to [logr::log_open](https://www.rdocumentation.org/packages/logr/versions/1.3.9/topics/log_open) function. It also calls internally the following functions to generate a unique file name based on the [file_name](#func.open_logfile.args.file_name) argument and _system time_:
...
#### [put_end_date](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/logging-functions.R#L19) Function {#func.put_end_date}
\
...
The source code of the [put_end_date](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/logging-functions.R#L19) function is shown below:
```{r eval=FALSE}
...
::: {.noteblock data-latex=""}
The source code of the [put_end_date](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/logging-functions.R#L19) function is defined in the [logging-functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/logging-functions.R#L19) script on _GitHub_.
:::
:::
...
Builds a character vector from the template passed in the [msg_template](#func.get_log1.args.msg_template) argument using the format value specified by the [arg1](#func.get_log1.args.arg1) argument.
...
This function internally calls [stringr::str_glue](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_glue) and [stringr::str_replace_all](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_replace) `R` functions to format a character vector from the template passed in the [msg_template](#func.get_log1.args.msg_template) argument using the format value specified by the [arg1](#func.get_log1.args.arg1)  argument.
...
Prints a string formed from the template passed in the [msg_template](#func.print_log1.args.msg_template) argument using the format value specified by the [arg1](#func.print_log1.args.arg1).
...
::: { #func.print_log1.args.msg_template .sidebar }
  - **msg_template:**Message template (or format string), i.e., any (possibly multiline) string containing at least one occurrence of a substring of the form `%1`. 

:::

::: { #func.print_log1.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.print_log1.args.msg_template) argument. 
...
This function internally calls the [base::print](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/print) `R` function to print the string (possibly multiline) produced by the (also called internally) [get_log1](#func.get_log1) function described above.
...
A glue object, as created by [glue::as_glue()](https://glue.tidyverse.org/reference/glue.html) from the character vector produced by the internally called [get_log1](#func.get_log1) function described above.
...
Outputs a string to the currently open log (using the [open_logfile](#func.open_logfile) function described above) formed from the template passed in the [msg_template](#func.put_log1.args.msg_template) argument using the format value specified by the [arg1](#func.put_log1.args.arg1).
...
::: { #func.put_log1.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.put_log1.args.msg_template) argument. 
...
This function internally calls the [logr::put](https://www.rdocumentation.org/packages/logr/versions/1.3.4/topics/log_print) `R` function to output the string (possibly multiline) produced by the (also called internally) [get_log1](#func.get_log1) function described above.
...
Builds a string from the template passed in the [msg_template](#func.get_log2.args.msg_template) argument using the format values specified by the [arg1](#func.get_log2.args.arg1) and [arg2](#func.get_log2.args.arg2) arguments.
...
::: { #func.get_log2.args.msg_template .sidebar }
  - **msg_template:** Message template (or format string), i.e., any (possibly multiline) string containing at least one combination of the following substrings: `%1`, `%2`. 

:::

::: { #func.get_log2.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.get_log2.args.msg_template) argument. 

:::

::: { #func.get_log2.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.get_log2.args.msg_template) argument. 
...
Prints a string formed from the template passed in the [msg_template](#func.print_log2.args.msg_template) argument using the format values specified by the [arg1](#func.print_log2.args.arg1) and [arg2](#func.print_log2.args.arg2) arguments.
...
::: { #func.print_log2.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.print_log2.args.msg_template) argument. 

:::

::: { #func.print_log2.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.print_log2.args.msg_template) argument. 
...
This function internally calls the [base::print](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/print) `R` function to print the string (possibly multiline) produced by the (also called internally) [get_log2](#func.get_log2) function described above.
...
A glue object, as created by [glue::as_glue()](https://glue.tidyverse.org/reference/glue.html) from the character vector produced by the internally called [get_log2](#func.get_log2) function described above.
...
Outputs a string to the currently open log (using the [open_logfile](#func.open_logfile) function described above) formed from the template passed in the [msg_template](#func.put_log2.args.msg_template) argument using the format values specified by the [arg1](#func.put_log2.args.arg1) and [arg2](#func.put_log2.args.arg2) arguments.
...
::: { #func.put_log2.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.put_log2.args.msg_template) argument. 

:::

::: { #func.put_log2.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.put_log2.args.msg_template) argument. 
...
This function internally calls the [logr::put](https://www.rdocumentation.org/packages/logr/versions/1.3.4/topics/log_print) `R` function to output the string (possibly multiline) produced by the (also called internally) [get_log2](#func.get_log2) function described above.
...
Builds a string from the template passed in the [msg_template](#func.get_log3.args.msg_template) argument using the format values specified by the [arg1](#func.get_log3.args.arg1), [arg2](#func.get_log3.args.arg2), and [arg3](#func.get_log3.args.arg3) arguments.
...
::: { #func.get_log3.args.msg_template .sidebar }
  - **msg_template:** Message template (or format string), i.e., any (possibly multiline) string containing at least one occurrence of each of the following substrings: `%1`, `%2`, `%3`. 

:::

::: { #func.get_log3.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.get_log3.args.msg_template) argument. 

:::

::: { #func.get_log3.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.get_log3.args.msg_template) argument. 

:::

::: { #func.get_log3.args.arg3 .sidebar }
  - **arg3:** The value to replace the format elements represented by the substring `%3` in the message template specified by the [msg_template](#func.get_log3.args.msg_template) argument. 
...
This function internally calls [stringr::str_glue](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_glue) and [stringr::str_replace_all](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_replace) `R` functions to format a string from the template using the format value passed in the [msg_template](#func.get_log3.args.msg_template), [arg1](#func.get_log3.args.arg1), [arg2](#func.get_log3.args.arg2), and [arg3](#func.get_log3.args.arg3)  arguments, respectively.
...
Prints a string formed from the template passed in the [msg_template](#func.print_log3.args.msg_template) argument using the format values specified by the [arg1](#func.print_log3.args.arg1), [arg2](#func.print_log3.args.arg2), and [arg3](#func.print_log3.args.arg3) arguments.
...
::: { #func.print_log3.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.print_log3.args.msg_template) argument. 

:::

::: { #func.print_log3.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.print_log3.args.msg_template) argument. 

:::

::: { #func.print_log3.args.arg3 .sidebar }
  - **arg3:** The value to replace the format elements represented by the substring `%3` in the message template specified by the [msg_template](#func.print_log3.args.msg_template) argument. 
...
This function internally calls the [base::print](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/print) `R` function to print the string (possibly multiline) produced by the (also called internally) [get_log3](#func.get_log3) function described above.
...
A glue object, as created by [glue::as_glue()](https://glue.tidyverse.org/reference/glue.html) from the character vector produced by the internally called [get_log3](#func.get_log3) function described above.
...
Outputs a string to the currently open log (using the [open_logfile](#func.open_logfile) function described above) formed from the template passed in the [msg_template](#func.put_log3.args.msg_template) argument using the format values specified by the [arg1](#func.put_log3.args.arg1), [arg2](#func.put_log3.args.arg2), and [arg3](#func.put_log3.args.arg3) arguments.
...
::: { #func.put_log3.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.put_log3.args.msg_template) argument. 

:::

::: { #func.put_log3.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.put_log3.args.msg_template) argument. 

:::

::: { #func.get_log3.args.arg3 .sidebar }
  - **arg3:** The value to replace the format elements represented by the substring `%3` in the message template specified by the [msg_template](#func.put_log3.args.msg_template) argument. 
...
This function internally calls the [logr::put](https://www.rdocumentation.org/packages/logr/versions/1.3.4/topics/log_print) `R` function to output the string (possibly multiline) produced by the (also called internally) [get_log3](#func.get_log3) function described above.
...
Builds a string from the template passed in the [msg_template](#func.get_log4.args.msg_template) argument using the format values specified by the [arg1](#func.get_log4.args.arg1), [arg2](#func.get_log4.args.arg2), [arg3](#func.get_log4.args.arg3) arguments, and [arg4](#func.get_log4.args.arg4) arguments.
...
::: { #func.get_log4.args.msg_template .sidebar }
  - **msg_template:** Message template (or format string), i.e., any (possibly multiline) string containing at least one occurrence of each of the following substrings: `%1`, `%2`, `%3`, `%4`. 

:::

::: { #func.get_log4.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.get_log4.args.msg_template) argument. 

:::

::: { #func.get_log4.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.get_log4.args.msg_template) argument. 

:::

::: { #func.get_log4.args.arg3 .sidebar }
  - **arg3:** The value to replace the format elements represented by the substring `%3` in the message template specified by the [msg_template](#func.get_log4.args.msg_template) argument. 

:::

::: { #func.get_log4.args.arg4 .sidebar }
  - **arg4:** The value to replace the format elements represented by the substring `%4` in the message template specified by the [msg_template](#func.get_log4.args.msg_template) argument. 
...
Prints a string formed from the template passed in the [msg_template](#func.print_log4.args.msg_template) argument using the format values specified by the [arg1](#func.print_log4.args.arg1), [arg2](#func.print_log4.args.arg2), [arg3](#func.print_log4.args.arg3), and [arg4](#func.print_log4.args.arg4) arguments.
...
::: { #func.print_log4.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.print_log4.args.msg_template) argument. 

:::

::: { #func.print_log4.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.print_log4.args.msg_template) argument. 

:::

::: { #func.print_log4.args.arg3 .sidebar }
  - **arg3:** The value to replace the format elements represented by the substring `%3` in the message template specified by the [msg_template](#func.print_log4.args.msg_template) argument. 

:::

::: { #func.print_log4.args.arg4 .sidebar }
  - **arg4:** The value to replace the format elements represented by the substring `%4` in the message template specified by the [msg_template](#func.print_log4.args.msg_template) argument. 
...
This function internally calls the [base::print](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/print) `R` function to print the string (possibly multiline) produced by the (also called internally) [get_log4](#func.get_log4) function described above.
...
A glue object, as created by [glue::as_glue()](https://glue.tidyverse.org/reference/glue.html) from the character vector produced by the internally called [get_log4](#func.get_log4) function described above.
...
Outputs a string to the currently open log (using the [open_logfile](#func.open_logfile) function described above) formed from the template passed in the [msg_template](#func.put_log4.args.msg_template) argument using the format values specified by the [arg1](#func.put_log4.args.arg1), [arg2](#func.put_log4.args.arg2), [arg3](#func.put_log4.args.arg3), and [arg4](#func.put_log4.args.arg4) arguments.
...
::: { #func.put_log4.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.put_log4.args.msg_template) argument. 

:::

::: { #func.put_log4.args.arg2 .sidebar }
  - **arg2:** The value to replace the format elements represented by the substring `%2` in the message template specified by the [msg_template](#func.put_log4.args.msg_template) argument. 

:::

::: { #func.get_log4.args.arg3 .sidebar }
  - **arg3:** The value to replace the format elements represented by the substring `%3` in the message template specified by the [msg_template](#func.put_log4.args.msg_template) argument. 

:::

::: { #func.get_log4.args.arg4 .sidebar }
  - **arg4:** The value to replace the format elements represented by the substring `%4` in the message template specified by the [msg_template](#func.put_log4.args.msg_template) argument. 
...
This function internally calls the [logr::put](https://www.rdocumentation.org/packages/logr/versions/1.3.4/topics/log_print) `R` function to output the string (possibly multiline) produced by the (also called internally) [get_log4](#func.get_log4) function described above.
...
Builds a message string from the template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument using the format element specified by the following arguments:

  - [arg.name](#func.msg.set_arg.args.arg.name): the pattern to be replaced by the value passed in the [arg] argument;
  
  - [arg](#func.msg.set_arg.args.arg): the value to replace all occurrences of the pattern passed in the [arg.name](#func.msg.set_arg.args.arg.name) argument.
...
```{r eval=FALSE}
msg.set_arg(msg_template, arg, arg, arg.name = "%1")
```
:::
...
::: { #func.msg.set_arg.args.arg.name .sidebar }
  - **arg.name:** Substring to replace in the message template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument with the value specified in the [arg](#func.msg.set_arg.args.arg) argument.

:::

::: { #func.msg.set_arg.args.arg .sidebar }
  - **arg:** Value to replace the format elements represented by the substring specified by the [arg.name](#func.msg.set_arg.args.arg.name) argument in the message template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument. 
:::
:::
...
This function internally calls [stringr::str_replace_all](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_replace) `R` functions to format a string from the message template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument using the format value specified by the [arg](#func.msg.set_arg.args.arg)  argument to replace all occurances of the substring specified by the [arg.name](#func.msg.set_arg.args.arg.name) argument (`%1` by default).
