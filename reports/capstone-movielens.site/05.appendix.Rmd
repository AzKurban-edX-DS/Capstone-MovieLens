...
::: {.noteblock data-latex=""}
In the [code snippet](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/logging-functions.R#L42) above, the function `get_log1` is called internally from the [put_log1](#func.print_log1) function described below in *this Section*.
:::
:::
...
::: {.noteblock data-latex=""}
In the [code snippet](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/logging-functions.R#55) above, the function `get_log2` is called internally from the [put_log2](#func.put_log2) function described below in *this Section*.
:::
:::
