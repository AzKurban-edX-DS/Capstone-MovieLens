...
::: {.noteblock data-latex=""}
In the code snippet above, the function `calc_date_general_effect` is called internally from the [train_UMGY_effect](#func.train_UMGY_effect) function described below.
:::
:::
