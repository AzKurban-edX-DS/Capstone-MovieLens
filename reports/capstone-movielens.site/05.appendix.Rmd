...
::: {.noteblock data-latex=""}
In the code snippet above, the function `calc_day_general_effect` is called internally along with the [calc_UMGY_SmoothedDay_effect](#func.calc_UMGY_SmoothedDay_effect) function from the [train_UMGY_SmoothedDay_effect](#func.train_UMGY_SmoothedDay_effect) function (both described below).
:::
:::
...
Data frame representing (*regularized* if [lambda](#func.calc_day_general_effect.args.lambda) argument value is non-default) *Date General Effect*.
:::
...
Data frame representing (*regularized* if [lambda](#func.calc_day_general_effect.cv.args.lambda) argument value is non-default) *Date General Effect*.
:::
...
Builds the *User+Movie+Genre+Year Effect (UMGYDE) Model* based on the *Date General Effect* data structure returned by the [calc_date_general_effect](#func.calc_date_general_effect) or [calc_date_general_effect.cv](#func.calc_date_general_effect.cv) function (both described above) and passed in the [date_general_effect](#func.calc_UMGY_SmoothedDay_effect.args.date_general_effect) argument.
