...
Calculates the arithmetic mean taking into account the _regularization parameter_ $\lambda$ passed in the [lambda] argument. We will call it the _penaized mean_.
...
We call this function internally from the functions that compute the _penalized estimates_  as described in section [Section 25.1 *Case study: recommendation systems / Penalized Least Squares*](https://rafalab.dfci.harvard.edu/dsbook-part-2/highdim/regularization.html#penalized-least-squares) of the _Course Textbook (New Edition)_[@IDS2_25-1].
