...
Builds a string from the template passed in the [msg_template](#func.get_log1.args.msg_template) argument using the format value specified by the [arg1](#func.get_log1.args.arg1).
...
::: { #func.get_log1.args.arg1 .sidebar }
  - **arg1:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.get_log1.args.msg_template) argument. 
...
Builds a message string from the template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument using the format element specified by the following arguments:
  - [arg.name](#func.msg.set_arg.args.arg.name): name of the element; 
  - [arg](#func.msg.set_arg.args.arg): the element value.
...
::: { #func.msg.set_arg.args.arg.name .sidebar }
  - **arg.name:** Value to replace the format elements represented by the substring specified by the [arg.name](#func.msg.set_arg.args.arg.name) argument in the message template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument. 
:::

::: { #func.msg.set_arg.args.arg .sidebar }
  - **arg:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.msg.set_arg.args.msg_template) argument. 
...
This function internally calls [stringr::str_glue](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_glue) and [stringr::str_replace_all](https://www.rdocumentation.org/packages/stringr/versions/1.5.0/topics/str_replace) `R` functions to format a string from the template using the format value passed in the [msg_template](#func.msg.set_arg.args.msg_template) and [arg](#func.msg.set_arg.args.arg)  arguments, respectively.
...
::: { #func.msg.glue.args.arg.name .sidebar }
  - **arg.name:** Value to replace the format elements represented by the substring specified by the [arg.name](#func.msg.glue.args.arg.name) argument in the message template passed in the [msg_template](#func.msg.glue.args.msg_template) argument. 
:::

::: { #func.msg.glue.args.arg .sidebar }
  - **arg:** The value to replace the format elements represented by the substring `%1` in the message template specified by the [msg_template](#func.msg.glue.args.msg_template) argument. 
