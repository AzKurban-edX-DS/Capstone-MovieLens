...
::: {.noteblock data-latex=""}
The complete source code of the functions described in this section are available in the [(R)MSE-related functions](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L3) section of the [common-helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R) script on _GitHub_.
:::
...
#### [rmse2](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L12) Function {#func.rmse2}
\
...
The source code of the [rmse2](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L12) function is shown below:
```{r eval=FALSE}
...
::: {.noteblock data-latex=""}
The source code of the [rmse2](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L12) function is also available in the [(R)MSE-related functions](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L3) section of the [common-helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L12) script on _GitHub_.
:::
:::
...
::: {.noteblock data-latex=""}
The complete source code of the functions described in this section are available in the [RMSEs Result Tibble](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L16) section of the [common-helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R) script on _GitHub_.
:::

#### [CreateRMSEs_ResultTibble](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L17) Function {#func.CreateRMSEs_ResultTibble}
\

Creates a _Result (RMSEs) Table_ of type *data frame*.
...
::: { #func.CreateRMSEs_ResultTibble.args .sidebar }
##### Details
\

This function is a wrapper for the [tibble::tibble](https://www.rdocumentation.org/packages/tibble/versions/3.2.1/topics/tibble) function, which is called internally to construct a data frame representing the _Result (RMSEs) Table_ to store the _RMSE_ values for every model used in the project to predict movie ratings.
...
The source code of the [CreateRMSEs_ResultTibble](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L17) function is shown below:
```{r eval=FALSE}
...
::: {.noteblock data-latex=""}
The source code of the [CreateRMSEs_ResultTibble](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L17) function is also available in the [RMSEs Result Tibble](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L16) section of the [common-helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L17) script on _GitHub_.
:::

#### [RMSEs.AddRow](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L22) Function {#func.RMSEs.AddRow}
\

Adds a row to the original _Result (RMSEs) Table_ passed in the [RMSEs](#func.RMSEs.AddRow.args.RMSEs) argument.
...
::: { #func.RMSEs.AddRow.args.RMSEs .sidebar }
  - ***RMSEs:*** Original _Resut (RMSEs) Table_ (of type *data frame*) to modify;
...
This function is a wrapper for the [tibble::add_row](https://www.rdocumentation.org/packages/tibble/versions/3.2.1/topics/add_row) function, which is called internally to modify a data frame representing the original _Result (RMSEs) Table_, which stores the _RMSE_ values for the models used in the project to predict movie ratings.
...
The source code of the [RMSEs.AddRow](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L22) function is shown below:
```{r eval=FALSE}
...
::: {.noteblock data-latex=""}
The source code of the [RMSEs.AddRow](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L22) function is also available in the [RMSEs Result Tibble](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L16) section of the [common-helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/common-helper.functions.R#L22) script on _GitHub_.
:::
...
::: { #func.RMSEs.AddDiffColumn.args.RMSEs .sidebar }
  - ***RMSEs:*** _Result (RMSEs) Table_ to modify;
...
The modified _Result (RMSEs) Table_.
...
Prints the _Result (RMSEs) Table_.
...
::: { #func.RMSE_kable.args.RMSEs .sidebar }
  - ***RMSEs:*** _Result (RMSEs) Table_ to print;
