...
::: {.noteblock data-latex=""}
This is an auxiliary function intended for use in other custom logging functions, such as the [print_log1](#func.print_log1) (as shown in section [Usage](#func.get_log1.usage) of *this Description*) and [put_log1](#func.put_log1) described below in *this Section*.
:::
