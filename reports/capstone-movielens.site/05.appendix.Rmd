...
Vector containing a value equals to minimum `RMSE` value in the *RMSE* column of the data frame passed in the [preset.result](#func.get_fine_tune.param.endpoints.idx.args.preset.result) argument, along with the pair of values those equal to the values of the nearest neighboring elements with values greater than the minimum to the left and right of the element (or group of elements) with the minimum value:
