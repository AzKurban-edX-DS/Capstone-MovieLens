...
::: { #func.RMSEs..params.RMSEs .sidebar }
...
::: { #func.RMSEs.AddRow.params .sidebar }
##### Parameters
\

::: { #func.RMSEs.AddRow.params.RMSEs .sidebar }
  - ***RMSEs:*** _Resut (RMSEs) Table_ to modify;

:::

::: { #func.RMSEs.AddRow.params.method .sidebar }
  - ***method:*** The _Method or Model_ being evaluated;

:::

::: { #func.RMSEs.AddRow.params.value .sidebar }
  - ***value:*** The _Root Mean Squared Error (RMSE)_ value;

:::

::: { #func.RMSEs.AddRow.params.comment .sidebar }
  - ***comment:*** Detailed information about the record or any other comment (if needed);

:::

::: { #func.RMSEs.AddRow.params.before .sidebar }
...
::: { #func.RMSE_kable.params .sidebar }
##### Parameters
\

::: { #func.RMSE_kable.params.RMSEs .sidebar }
  - ***RMSEs:*** _Resut (RMSEs) Table_ to print;

:::

::: { #func.RMSE_kable.params.col1width .sidebar }
  - ***col1width:*** Width of the first column;

:::

::: { #func.RMSE_kable.params.col2width .sidebar }
  - ***col2width:*** Width of the second column;

:::

::: { #func.RMSE_kable.params.col3width .sidebar }
...
::: { #func.RMSE.Total_kable.params .sidebar }
##### Parameters
\

::: { #func.RMSE.Total_kable.params.RMSEs .sidebar }
  - ***RMSEs:*** _Resut (RMSEs) Table_ to print;
