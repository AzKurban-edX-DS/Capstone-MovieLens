...
::: { #func.calc_UMGY_SmoothedDay_effect.args.degree .sidebar }
  - **degree:** (Integer, $NA$ by default) The degree of the polynomials to be used (passed in the same-named argument to the internally called [loess_de](#func.loess_de) described above); 

:::
::: { #func.calc_UMGY_SmoothedDay_effect.args.span .sidebar }
  - **span:** (Numeric, $NA$ by default ) The parameter $\alpha$, which controls the degree of smoothing (passed in the same-named argument to the internally called [loess_de](#func.loess_de) described above); 
...
::: { #func.train_UMGY_SmoothedDay_effect.args.degree .sidebar }
  - **degree:** (Integer, $NA$ by default) The degree of the polynomials to be used (passed in the same-named argument to the internally called [calc_UMGY_SmoothedDay_effect](#func.calc_UMGY_SmoothedDay_effect) described above); 

:::
::: { #func.train_UMGY_SmoothedDay_effect.args.span .sidebar }
  - **span:** (Numeric, $NA$ by default ) The parameter $\alpha$, which controls the degree of smoothing (passed in the same-named argument to the internally called [calc_UMGY_SmoothedDay_effect](#func.calc_UMGY_SmoothedDay_effect) described above); 
...
Internally, this function calls the helper functions [calc_day_general_effect](#func.calc_day_general_effect) and [calc_UMGY_SmoothedDay_effect](#func.calc_UMGY_SmoothedDay_effect) (both described above in this section), passing the values of the arguments [degree](#func.calc_UMGY_SmoothedDay_effect.args.degree) and [span](#func.calc_UMGY_SmoothedDay_effect.args.span) to the latter function in the same-named arguments.
...
Data frame representing the *UMGYDE Model* trained (and also *regularized* if the [lambda](#func.train_UMGY_SmoothedDay_effect.cv.args.lambda) argument value is other than the default) with use of *K-Fold Cross-Validation*, where the $K$ is the length of the [`edx_CV` Object] (in *this Project* we use $K = 5$).
:::
...
::: { #func.UMGY_SmoothedDay_effect.predict.args.UMGYD_effect .sidebar }
  - **UMGYD_effect:** Data frame representing the *UMGYDE Model*. 
