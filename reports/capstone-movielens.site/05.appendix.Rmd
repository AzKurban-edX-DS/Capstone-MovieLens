...
::: {.noteblock data-latex=""}
This is a helper function and is used internally in the [init_source_datasets](#func.init_source_datasets) function as shown above in the [Usage](#func.make_source_datasets.usage) section of *this Description*.
:::
:::
...
Unzipping MovieLens data file from zip-archive: {movielens_datasets_zip}...") 
    ...
    # Ensuring that the unzipped file has been successfully saved in the file system...
    if(!file.exists(movielens_datasets_file_path)) {
      put_log("Method `init_source_datasets`: 
...
::: {.noteblock data-latex=""}
This is an auxiliary function intended for use in the [make_source_datasets](#func.make_source_datasets) function as shown in the [Usage](#func.splitByUser.usage) section above of *this Description*.
:::
:::
...
Dataset object with split rows (those belong to multiple genres) described in detail below in the [`edx.sgr` Object] section of the [Appendix B: Models Training Datasets].
:::
...
::: {.noteblock data-latex=""}
In the code snippet above, the `loess_de` is called internally from the [calc_UMGY_SmoothedDay_effect](#func.calc_UMGY_SmoothedDay_effect) function described below in *this Section*.
:::
:::
