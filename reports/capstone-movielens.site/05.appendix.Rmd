...
::: { #func.RMSE.Total_kable.args. .sidebar }
  - ***col1width:*** (Optional, 15 by default) Width of the first column (15 by default);

:::

::: { #func.RMSE.Total_kable.args. .sidebar }
  - ***col2width:*** (Optional, 7 by default) Width of the second column (7 by default);

:::

::: { #func.RMSE.Total_kable.args. .sidebar }
  - ***col3width:*** (Optional, 5 by default) Width of the third column(5 by default);

:::

::: { #func.RMSE.Total_kable.args. .sidebar }
  - ***col4width:*** (Optional, 25 by default) Width of the fourth column (25 by default);
...
Selects the best values from a pair of matched vectors: a vector of sorted *tuning parameter* values and a vector of corresponding *Root Mean Squared Errors (RMSE)* values passed in the [param_values](#func.tune.model_param.args.param_values) and [RMSEs](#func.get_best_param.result.args.RMSEs) arguments, respectively.
...
The function checks whether the required source datasets are cached on the hard disk and, if so, loads them from the cache file internally calling the [load_movielens_data_from_file](#func.load_movielens_data_from_file) user-defined helper function described below in section [Data Processing Functions] of *this Appendix*.

Otherwise, it calls the [make_source_datasets](#func.make_source_datasets) function described above, which creates all the necessary datasets using the `edx` as the original dataset.
...
Reload *Movielens* datasets from the cach file written with the function [base::save](https://www.rdocumentation.org/packages/base/versions/3.3.0/topics/save) using the path passed in the [file_path](#func.load_movielens_data_from_file.args.file_path) argument.
...
::: {.noteblock data-latex=""}
In the code snippet above, the function `load_movielens_data_from_file` is called internally from the [init_source_datasets](#func.init_source_datasets) function described above in section [Initializing Input Datasets] of *this Appendix*.
:::
:::
...
This function is a wrapper for the [base::load](https://www.rdocumentation.org/packages/base/versions/3.3.0/topics/load) `R` function. It also calls internally auxiliary `R` function [base::file.exists](https://www.rdocumentation.org/packages/base/versions/3.3.0/topics/files), as well as the following user-defined logging functions described in section [Logging Functions] of *this Appendix*:
...
::: {.noteblock data-latex=""}
This is an auxiliary function that is used internally in the [init_source_datasets](#func.init_source_datasets) function (described above in section [Initializing Input Datasets] to *this Appendix*) as shown above in the [Usage](#func.load_movielens_data_from_file.usage) section of *this Description*.
:::
:::
...
::: { #func.data.plot.args.xlabel .sidebar }
  - **xlabelL:** (Character string, `NULL` by default) The $x$ axis label. If `NULL`, the value of the `xname` parameter is used for the label; 

:::
::: { #func.data.plot.args.ylabel .sidebar }
  - **ylabel:** (Character string, `NULL` by default) The $y$ axis label. If `NULL`, the value of the `yname` parameter is used for the label.; 

:::
::: { #func.data.plot.args.line_col .sidebar }
  - **line_col:** (Character string, ***\textcolor{blue}{blue}*** by default) Line color. 

:::
::: { #func.data.plot.args.normalize .sidebar }
- **normalize:** (Boolean, `FALSE` by default) If `TRUE`, deviations from the minimum $y$ value are used to plot, rather than the $y$ values themselves. Otherwise, the $y$ values are used.
...
::: {.noteblock data-latex=""}
In the code snippet above, the function `data.plot.left.n` is called internally from the [data.plot.left_detailed](#func.data.plot.left_detailed) function described below in this section.
:::
:::
...
::: { #func.data.plot.left.n.args.left.n .sidebar }
  - **left.n:** (Integer, $0$ by default)If a positive numeric value, specifies the number of the first rows of the dataset to plot. Otherwise, the entire dataset data is set to plot. 
...
::: { #func.data.plot.left.n.args.line_col .sidebar }
  - **line_col:** (Character string, ***\textcolor{red}{red}*** by default) Line color. 
...
::: { #func.data.plot.left_detailed.args.xlabel1 .sidebar }
  - **xlabel1:** (Character string, `NULL` by default) The $x$ axis label for the first plot. If `NULL`, the value of the `xname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.args.xlabel2 .sidebar }
  - **xlabel2:** (Character string, `NULL` by default) The $x$ axis label for the second plot. If `NULL`, the value of the `xname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.args.ylabel1 .sidebar }
  - **ylabel1:** (Character string, `NULL` by default) The $y$ axis label for the first plot. If `NULL`, the value of the `yname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.args.ylabel2 .sidebar }
  - **ylabel2:** (Character string, `NULL` by default) The $y$ axis label for the second plot. If `NULL`, the value of the `yname` parameter is used for the label. 

:::
::: { #func.data.plot.left_detailed.args.line_col .sidebar }
  - **line_col1** (Character string, ***\textcolor{blue}{blue}*** by default) The line color (main graqh). 

:::
::: { #func.data.plot.left_detailed.args.line_col .sidebar }
  - **line_col2** (Character string, ***\textcolor{red}{red}*** by default) The line color (second graph: the left part of the main graph, which is shown on an enlarged scale). 
...
::: {.noteblock data-latex=""}
*Regularization* is committed through the *penalized regression* by computing the *penalized mean* performed by the internally called [mean_reg](#func.mean_reg) function described above in the [Common Helper Functions]/[Model Tuning Utils] section of *this Appendix*.
:::
:::
...
::: {.noteblock data-latex=""}
In the code snippet above this function is passed in the [fn_tune.test.param_value](#func.tune.model_param.args.fn_tune.test.param_value) argument to the [tune.model_param](#func.tune.model_param) function described above in the section [Common Helper Functions]/[Model Tuning Utils] of *this Appendix*.
...
::: {.noteblock data-latex=""}
This function is an auxiliary function specifically designed to be passed in the `fn_tune.test.param_value` argument to the [tune.model_param](#func.tune.model_param) and [model.tune.param_range](#func.model.tune.param_range) functions described above in the [Common Helper Functions]/[Model Tuning Utils] section of *this Appendix*.
:::
:::
...
Internally, this function calls the helper function [calc_date_general_effect](#func.calc_date_general_effect) described above for each iteration of the *K-Fold Cross-Validation* applied to the [`edx_CV` Object] described below in the [Appendix B: Models Training Datasets]. It also calls internally the [union_cv_results](#func.union_cv_results) function described above in the *Data Helper Functions / [Models Training Functions]* section of this *Appendix* to aggregate the cross-validation results.
...
Internally, this function calls the helper functions [calc_date_general_effect](#func.calc_date_general_effect) and [calc_UMGY_effect](#func.calc_UMGY_effect) (both described above in this section).
...
Internally, this function calls the helper functions [calc_date_general_effect.cv](#func.calc_date_general_effect.cv) and [calc_UMGY_effect](#func.calc_UMGY_effect) (both described above in this section).
...
Data frame object representing the *UMGY Effect Model* trained (and also *regularized* if the [lambda](#func.train_UMGY_effect.cv.args.lambda) argument value is other than the default) with use of *K-Fold Cross-Validation*, where the $K$ is the length of the [`edx_CV` Object] (in *this Project* we use $K = 5$).
:::
...
Data frame object representing (*regularized* if [lambda](#func.calc_day_general_effect.args.lambda) argument value is non-default) *DG Effect*.
:::
...
Internally, this function calls the helper functions [calc_day_general_effect](#func.calc_day_general_effect) function described above for each iteration of the *K-Fold Cross-Validation* applied to the [`edx_CV` Object] described below in the [Appendix B: Models Training Datasets]. It also calls internally the [union_cv_results](#func.union_cv_results) function described above in the *Data Helper Functions / [Models Training Functions]* section of this *Appendix* to aggregate the cross-validation results.
...
Data frame object representing the *Day General Effect* data. 
...
::: { #func.train_UMGY_SmoothedDay_effect.RMSE.cv.args.degree .sidebar }
  - **degree:** (Integer, `NA` by default) *The [loess](https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/loess) parameter*: the degree of the polynomials to pass in the same-named argument to the internally called [train_UMGY_SmoothedDay_effect.cv](#func.train_UMGY_SmoothedDay_effect.cv) described above; 
...
::: {.noteblock data-latex=""}
In the code snippet above the `train_UMGY_SmoothedDay_effect.RMSE.cv.degree0` function is passed in the [fn_tune.test.param_value](#func.tune.model_param.args.fn_tune.test.param_value) argument to the [tune.model_param](#func.tune.model_param) function described above in the section [Common Helper Functions]/[Model Tuning Utils] of *this Appendix*.
:::
:::
...
::: {.noteblock data-latex=""}
This is an auxiliary function intended to be passed in the `fn_tune.test.param_value` argument to the [tune.model_param](#func.tune.model_param) and [model.tune.param_range](#func.model.tune.param_range) functions described above in the [Common Helper Functions]/[Model Tuning Utils] section of *this Appendix*.
:::
:::
...
::: {.noteblock data-latex=""}
In the code snippet above the `train_UMGY_SmoothedDay_effect.RMSE.cv.degree1` function is passed in the [fn_tune.test.param_value](#func.model.tune.param_range.args.fn_tune.test.param_value) argument to the [model.tune.param_range](#func.model.tune.param_range) function described above in the section [Common Helper Functions]/[Model Tuning Utils] of *this Appendix*.
:::
:::
...
::: {.noteblock data-latex=""}
In the code snippet above the `train_UMGY_SmoothedDay_effect.RMSE.cv.degree2` function is passed in the [fn_tune.test.param_value](#func.model.tune.param_range.args.fn_tune.test.param_value) argument to the [model.tune.param_range](#func.model.tune.param_range) function described above in the section [Common Helper Functions]/[Model Tuning Utils] of *this Appendix*.
:::
:::
...
This is an auxiliary function intended to be called internally from the [regularize.test_lambda.UMGYD_effect.cv](#func.regularize.test_lambda.UMGYD_effect.cv) function (described below in this section) as shown in the [Usage](#func.calc_UMGY_SmoothedDay_effect.MSE.usage) section of *this Description* above.
...
::: {.noteblock data-latex=""}
In the code snippet above this function is passed in the [fn_tune.test.param_value](#func.model.tune.param_range.args.fn_tune.test.param_value) argument to the [model.tune.param_range](#func.model.tune.param_range) function described above in the section [Common Helper Functions]/[Model Tuning Utils] of *this Appendix*.
...
Computes residuals, defined as the difference between the observed and predicted values of the fully trained _UMGYDE Model_ as described in the [User+Movie+Genre+Year+SmoothedDay Effect (UMGYDE) Model] section.
