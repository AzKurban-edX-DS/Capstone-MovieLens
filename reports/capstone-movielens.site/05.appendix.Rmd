...
This function produces datasets listed in the [Value](#func.make_source_datasets.value) section below and described in detail in [Appendix B: Model Training Datasets] using the `edx` as the original dataset.
...
The pseudocode of the [make_source_datasets](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L89) function is shown below:
```{r eval=FALSE}
...
::: {.noteblock data-latex=""}
The complete source code of the [make_source_datasets](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L89) function is available in the [Initializing input datasets](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L88) section of the [data.helper.functions.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L89) script on _GitHub_.
:::
:::
...
## Model Training: Support Functions
\
...
# Appendix B: Model Training Datasets {#appndx_b}
\
