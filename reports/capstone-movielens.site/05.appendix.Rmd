...
Data frame representing the *UM Effect Model* trained (and also *regularized* if the [lambda](#func.train_user_movie_effect.cv.args.lambda) argument value is other than the default) using _5-Fold Cross-Validation_.
:::
...
Calculates *Root Mean Squared Error (RMSE)* for the *UM Effect (UME) Model* produced by the [train_user_movie_effect.cv](#func.train_user_movie_effect.cv) function call.
...
To calculate the *MSE* for the *UME Model* passed in the [um_effect](#func.calc_user_movie_effect_RMSE.args.um_effect) argument, the function uses the validation dataset passed in the [test_set](#func.calc_user_movie_effect_RMSE.args.test_set) arg. 
...
To calculate the *RMSE* for the *UME Model* passed in the [um_effect](#func.calc_user_movie_effect_RMSE.args.um_effect) argument, the function uses the validation dataset passed in the [test_set](#func.calc_user_movie_effect_RMSE.args.test_set) arg. 
