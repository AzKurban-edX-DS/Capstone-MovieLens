...
::: {.noteblock data-latex=""}
The function calls internally the following user-defined helper functions: 

* The *data helper functions* described below in section [Data Processing Functions] of *this Appendix*:
...
* The *custom logging functions* described above in section [Logging Functions] of *this Appendix*:
...
::: {.noteblock data-latex=""}
In the [code snippet](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L153) above, the function `sample_train_validation_sets` is called internally from the [make_source_datasets](#func.make_source_datasets) function described below in *this Section*.
:::
:::
...
::: {.noteblock data-latex=""}
This is an auxiliary function intended for use in the [make_source_datasets](#func.make_source_datasets) function as shown in the [Usage](#) section above of the *current Description*.
:::
