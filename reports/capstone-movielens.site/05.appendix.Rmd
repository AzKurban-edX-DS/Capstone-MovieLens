...
Builds a character vector from the template passed in the [msg_template](#func.msg.set_arg.args.msg_template) argument using the format element specified by the following arguments:

  - [arg.name](#func.msg.set_arg.args.arg.name): the pattern to be replaced by the value passed in the [arg](#func.msg.set_arg.args.arg) argument;
