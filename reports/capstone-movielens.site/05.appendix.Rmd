...
```
  ...
  2. Checks if the *step size* of the generated sequence is less than the minimum allowed value (in the current implementation, we use `1e-13`), and if `TRUE`, breaks out of the loop:
```{r eval=FALSE}
...
:::  
  ...
  3. Creates a vector containing a sequence of $\lambda$ values generated as described in the [loop_starter](#func.model.tune.param_range.args.loop_starter) argument description above.
  
  2. Calls the [tune.model_param](#func.tune.model_param) function, passing the vector created in the previous step to the [param_values](#func.tune.model_param.args.param_values) argument (along with the values of the other arguments) of the `tune.model_param` function.
