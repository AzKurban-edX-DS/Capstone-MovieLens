...
This function internally calls the [base::print](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/print) `R` function to print the string (possibly multiline) produced by the (also called internally) [print_log1](#func.print_log1) function described above.
...
A glue object, as created by [glue::as_glue()](https://glue.tidyverse.org/reference/glue.html) from the character vector produced by the internally called [print_log1](#func.print_log1) function described above.
...
print_log1 <- function(msg_template, arg1){
  print(print_log1(msg_template, arg1))
}
```
...
This function internally calls the [logr::put](https://www.rdocumentation.org/packages/logr/versions/1.3.4/topics/log_print) `R` function to output the string (possibly multiline) produced by the (also called internally) [put_log1](#func.put_log1) function described above.
...
A glue object, as created by [glue::as_glue()](https://glue.tidyverse.org/reference/glue.html) from the character vector produced by the internally called [put_log1](#func.put_log1) function described above.
:::
...
put_log1 <- function(msg_template, arg1){
  put(put_log1(msg_template, arg1))
}
```
