...
Validates the *Regularization Parameter* $\lambda$ passed in the [lambda](#func.regularize.test_lambda.UM_effect.cv.args.lambda) argument for the *User+Movie (UM) Effect Model* in the *regularization process* using the *penalized approach* with use of *K-Fold Cross-Validation*.
