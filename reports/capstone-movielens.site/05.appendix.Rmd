...
::: {.noteblock data-latex=""}
This is a helper function intended for use in other helper functions (such as, for instance, [train_user_movie_effect](#func.train_user_movie_effect) as shown above in the [Usage](#func.get_log.usage) section of *this Description*) that compute *penalized estimates* during the *regularization* process of the models being trained[@IDS2_24-2]. All these functions are described below in section [Models Training: Support Functions] of *this Appendix*.
:::
