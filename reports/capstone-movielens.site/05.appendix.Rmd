...
Outputs a string to the currently open log (using the [open_logfile](#func.open_logfile) function described above) formed from the template passed in the [msg_template](#func.get_log1.args.msg_template) argument using the format value specified by the [arg1](#func.get_log1.args.arg1).
