...
::: {.noteblock data-latex=""}
In the code snippet above, we use the user-defined function [mse](#func.mse) described in the [Common Helper Functions]/[(Root) Mean Squared Error Calculation] section of [Appendix A](#appndx_a).
:::
