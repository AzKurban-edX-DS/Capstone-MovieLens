...
Finally, we are ready to compute the `RMSE` (additionally using the [clamp](#func.clamp) helper function we described above to keep predictions in the proper range):
