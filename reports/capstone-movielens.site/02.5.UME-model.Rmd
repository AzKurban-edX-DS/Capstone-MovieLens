...
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
For this purpose, we will use the helper function [model.tune.param_range](#func.model.tune.param_range), passing the  function (already mentioned above in the [UME Model Regularization: *Pre-configuration*] section) as the value of its argument [fn_tune.test.param_value](#func.model.tune.param_range.args.fn_tune.test.param_value).
