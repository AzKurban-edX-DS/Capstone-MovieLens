...
::: {.noteblock data-latex=""}
In the code snippet above we use the [train_user_movie_effect.cv](#func.train_user_movie_effect.cv) function described in the [UME Model Utility Functions] section of [Appendix A: Support Functions].
:::
...
In the code snippet above, we use the following functions described in [Appendix A: Support Functions]: 
  ...
  - [calc_user_movie_effect_RMSE.cv](#func.calc_user_movie_effect_RMSE.cv) (described in the [UME Model Utility Functions] section) to calculate the *RMSE* for the *Current Model*;
  
  - [RMSEs.AddRow](#func.RMSEs.AddRow) and [RMSE_kable](#func.RMSE_kable) (described in the [Result RMSEs Tibble Functions] section) to update and print the table above.
:::
