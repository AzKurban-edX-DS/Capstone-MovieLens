...
::: {.noteblock data-latex=""}
In the code snippet above we use the [train_user_movie_effect.cv](#func.train_user_movie_effect.cv) helper function described in the [UME Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippet above, we use the [calc_user_movie_effect_RMSE.cv](#func.calc_user_movie_effect_RMSE.cv) function described in the [UME Model: Utility Functions] section of [Appendix A](#appndx_a). 
:::
...
::: {.noteblock data-latex=""}
In the code snippet above we use the [train_user_movie_effect](#func.train_user_movie_effect) function described in the [UME Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
