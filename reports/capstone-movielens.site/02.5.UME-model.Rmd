...
writeLines("*** Fine-tuning: best parameter value ***")
...
#### Retraining User+Movie Effect Model with the best $\lambda$
\
...
writeLines('')
  ...
  print_log1("Re-training Regularized User+Movie Effect Model for the best `lambda`: %1...",
           UME.rglr.best_lambda)
writeLines("------")
writeLines('')
...
Finally, after _Regularization_, we obtained the following result:
```{r, eval=FALSE}
