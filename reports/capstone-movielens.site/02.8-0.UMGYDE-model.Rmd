...
A data structure containing information about _Day General Effect_. 
...
###### ***de_bias.dat***
\
The _day general effect_ data, which is a data structure returned by any of the following functions described above:
...
A data structure containing information about _User+Movie+Genre+Year (UMGYD) Effect_. 
...
This is a helper function that calculates the _UMGYD Effect_ of the user ratings and is intended to be used in other functions and scripts (such as [train_UMGYD_effect](#func.train_UMGYD_effect)) described below.
...
`lambda` is `NA`")
  ...
  calc_day_general_effect.cv(lambda) |> calc_UMGYD_effect()  
}
```
