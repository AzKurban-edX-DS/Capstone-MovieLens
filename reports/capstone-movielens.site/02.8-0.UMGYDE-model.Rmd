...
::: {.noteblock data-latex=""}
The complete source code of the ***Step 1*** of the current model tuning is available in the [UMGYDE Model Tuning: Step 1 (`degree = `)](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L1823) section of the [capstone-movielens.main.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L1823) script on _GitHub_.
:::
...
::: {.noteblock data-latex=""}
The complete source code the ***Step 2*** of the current model tuning is available in the [UMGYDE Model Tuning: Step  (`degree = `)](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L1) section of the [capstone-movielens.main.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L1) script on _GitHub_.
:::
...
::: {.noteblock data-latex=""}
The complete source code the ***Step 3*** of the current model tuning is available in the [UMGYDE Model Tuning: Step  (`degree = `)](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L1) section of the [capstone-movielens.main.R](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L1) script on _GitHub_.
:::
