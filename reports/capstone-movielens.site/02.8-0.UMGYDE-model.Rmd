...
::: {.noteblock data-latex=""}
The custom data visualization function [data.plot.left_detailed](#func.data.plot.left_detailed) we used above is described in the [Data Helper Functions] section of the [Appendix] to this report.
:::
