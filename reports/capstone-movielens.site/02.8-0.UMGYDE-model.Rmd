...
::: {.noteblock data-latex=""}
In the code snippets above, we use the [calc_UMGY_SmoothedDay_effect.RMSE.cv](#func.calc_UMGY_SmoothedDay_effect.RMSE.cv) user-defined described in the [Models Training: Support Functions]/[UMGYDE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippet above we use the [regularize.train_UMGYD_effect](#func.regularize.train_UMGYD_effect) function described in the [Models Training: Support Functions]/[UMGYDE Model: Regularization] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippet above we use the [UMGY_SmoothedDay_effect.predict](#func.UMGY_SmoothedDay_effect.predict) function described in the [Models Training: Support Functions]/[UMGYDE Model: Utility Functions] section of [Appendix A](#appndx_a).
:::
...
::: {.noteblock data-latex=""}
In the code snippet above, we use the [rmse2](#func.rmse2) user-defined function described in the [Common Helper Functions]/[(Root) Mean Squared Error Calculation] section of [Appendix A](#appndx_a).
:::
