...
Now, we can add the best *RMSE* figured out for the *UMGYDE Fine-tuned Model* with the [loess] `degree = 0` (let's call it *Tuned UMGYDE.d0 Model*) to our *Result Table*:
```{r, eval=FALSE}
