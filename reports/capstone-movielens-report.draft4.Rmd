...
::: {.noteblock data-latex=""}
The full source code of these functions is available in the [Logging Helper function section](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R#L20) of the [Capstone MovieLens Main R Script](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/capstone-movielens.main.R).
:::
...
::: {.noteblock data-latex=""}
This code snippet is a part of the [make_source_datasets](https://github.com/AzKurban-edX-DS/Capstone-MovieLens/blob/main/r/src/support-functions/data.helper.functions.R#L87) _function_ code described above.
:::
