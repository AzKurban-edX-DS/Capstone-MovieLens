...
(ref:foo) During execution, the function uses a helper function specified by the `fn_tune.test.param_value` parameter, which calculates the `RMSE` value for the given parameter from the list determined by the inner `param_values` sequence.


###### Value
\
See the `Details`section [above](#func.model.tune.param_range.details). 
See the `Details`section [above](ref:foo). 
